...
final class Tokens {
    ...
    static String getProblemWhat(Token token) {
        ...
        throw new BugOrBroken("tried to get problem what from " + token);
    }
    ...
    static String getProblemMessage(Token token) {
        ...
        throw new BugOrBroken("tried to get problem message from " + token);
    }
    ...
    static boolean getProblemSuggestQuotes(Token token) {
        ...
        throw new BugOrBroken("tried to get problem suggestQuotes from " + token);
    }
    ...
    static Throwable getProblemCause(Token token) {
        ...
        throw new BugOrBroken("tried to get problem cause from " + token);
    }
    ...
    static String getCommentText(Token token) {
        ...
        throw new BugOrBroken("tried to get comment text from " + token);
    }
    ...
    static boolean getSubstitutionOptional(Token token) {
        ...
        throw new BugOrBroken("tried to get substitution optionality from " + token);
    }
