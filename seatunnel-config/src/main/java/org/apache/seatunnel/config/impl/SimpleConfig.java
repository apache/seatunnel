...
final class SimpleConfig implements Config, MergeableValue, Serializable {
    ...
    private enum MemoryUnit {
        ...
        private static Map<String, MemoryUnit> UNITS_MAP = makeUnitsMap();
