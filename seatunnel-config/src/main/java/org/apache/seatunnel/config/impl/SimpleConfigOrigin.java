...
final class SimpleConfigOrigin implements ConfigOrigin {
    ...
    protected SimpleConfigOrigin(String description, int lineNumber, int endLineNumber, OriginType originType,
        ...
        if (description == null) {
            throw new BugOrBroken("description may not be null");
        }
    ...
    static ConfigOrigin mergeOrigins(Collection<? extends ConfigOrigin> stack) {
        if (stack.isEmpty()) {
            throw new BugOrBroken("can't merge empty list of origins");
            ...
            if (m.containsKey(f) && ConfigImplUtil.equalsHandlingNull(baseEntry.getValue(), m.get(f))) {
                ...
                switch (f) {
                    case ORIGIN_DESCRIPTION:
                        throw new BugOrBroken("origin missing description field? " + child);
                    ...
                    case ORIGIN_END_LINE_NUMBER:
                        ...
                        break;
                    case ORIGIN_TYPE:
                        throw new BugOrBroken("should always be an ORIGIN_TYPE field");
                    case ORIGIN_URL:
                    ...
                    case ORIGIN_NULL_COMMENTS:
                        throw new BugOrBroken("computing delta, base object should not contain " + f + " " + base);
                    case END_MARKER:
                    case ROOT_VALUE:
                    ...
                    case VALUE_DATA:
                    case VALUE_ORIGIN:
                        throw new BugOrBroken("should not appear here: " + f);
                    default:
                }
            }
            ...
            if (delta.containsKey(f)) {
                ...
                switch (f) {
                    ...
                    case ORIGIN_NULL_COMMENTS: // FALL THRU
                        ...
                        throw new BugOrBroken("applying fields, base object should not contain " + f + " " + base);
