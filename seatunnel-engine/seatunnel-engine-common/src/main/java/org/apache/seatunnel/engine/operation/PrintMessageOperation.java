...
import org.apache.seatunnel.engine.serializable.EngineOperationDataSerializerHook;
...
public class PrintMessageOperation extends Operation implements IdentifiedDataSerializable, AllowedDuringPassiveState {
    ...
    public final int getFactoryId() {
        return EngineOperationDataSerializerHook.FACTORY_ID;
    }

    @Override
    public int getClassId() {
        return EngineOperationDataSerializerHook.PRINT_MESSAGE_OP;
    }
