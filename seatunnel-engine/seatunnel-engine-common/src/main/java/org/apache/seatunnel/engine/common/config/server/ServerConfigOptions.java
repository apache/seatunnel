...
public class ServerConfigOptions {
    ...
    public static final Option<String> QUEUE_TYPE = Options.key("queue_type").stringType().defaultValue("blockingQueue").withDescription("The internal data cache queue type.");
