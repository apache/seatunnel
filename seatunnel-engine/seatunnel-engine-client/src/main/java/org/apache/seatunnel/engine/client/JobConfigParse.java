...
public class JobConfigParse {
        ...
        if (CollectionUtils.isEmpty(transformConfigList)) {
            ...
            transformConfigList.stream().forEach(config -> {
                ...
                TransformAction transformAction =
                    new TransformAction(idGenerator.getNextId(), seaTunnelTransform.getPluginName(), seaTunnelTransform);
    ...
    private List<Action> sampleAnalyze(List<? extends Config> sourceConfigs,
        ...
        SourceAction sourceAction = new SourceAction(idGenerator.getNextId(), seaTunnelSource.getPluginName(), seaTunnelSource);
