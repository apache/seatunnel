...
package org.apache.seatunnel.engine.kubernetes.kubeclient.resources;

import io.fabric8.kubernetes.api.model.Pod;
import org.apache.seatunnel.engine.kubernetes.kubeclient.ZetaKubeClient;
import org.apache.seatunnel.engine.kubernetes.utils.KubernetesUtils;
...
public class KubernetesPodsWatcher extends AbstractKubernetesWatcher<Pod, KubernetesPod> {
    ...
    public KubernetesPodsWatcher(ZetaKubeClient.WatchCallbackHandler<KubernetesPod> callbackHandler) {
