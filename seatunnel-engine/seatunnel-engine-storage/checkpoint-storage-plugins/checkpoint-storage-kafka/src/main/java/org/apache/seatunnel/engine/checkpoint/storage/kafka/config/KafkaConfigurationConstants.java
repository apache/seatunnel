...
package org.apache.seatunnel.engine.checkpoint.storage.kafka.config;

public class KafkaConfigurationConstants {
    public static final String KAFKA_BOOTSTRAP_SERVERS = "bootstrap.servers";
    public static final String KAFKA_CHECKPOINT_STORAGE_COMPACT_TOPIC =
            "checkpoint.storage.compact.topic";
