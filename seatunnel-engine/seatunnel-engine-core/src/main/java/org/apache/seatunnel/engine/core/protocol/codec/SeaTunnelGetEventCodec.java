...
public final class SeaTunnelGetEventCodec {
    ...
    private static final int REQUEST_IS_ALL_FIELD_OFFSET = REQUEST_JOB_ID_FIELD_OFFSET + LONG_SIZE_IN_BYTES;
    ...
    public static SeaTunnelGetEventCodec.RequestParameters decodeRequest(ClientMessage clientMessage) {
