...
//        ((HazelcastInstanceProxy) HazelcastInstanceFactory.newHazelcastInstance(new Config(),
...
//
//        CompletableFuture<TaskExecutionState> completableFuture = taskExecutionService.deployTask(
//            new TaskGroupDefaultImpl(1l, "ts", Lists.newArrayList(testTask1, testTask2)));
//
...
//        CompletableFuture<Void> cancellationFuture = new CompletableFuture<Void>();
//
//        CompletableFuture<TaskExecutionState> completableFuture = taskExecutionService.submitTaskGroup(
//            new TaskGroupDefaultImpl("ts", Lists.newArrayList(testTask1, testTask2)), cancellationFuture);
...
//            taskExecutionService.submitTaskGroup(new TaskGroupDefaultImpl("t1", Lists.newArrayList(criticalTask)),
...
//
//        CompletableFuture<TaskExecutionState> taskCts =
//            taskExecutionService.deployTask(new TaskGroupDefaultImpl("ts", Lists.newArrayList(tasks)),
//                new CompletableFuture<Void>());
//
//
//        CompletableFuture<TaskExecutionState> t1c =
//            taskExecutionService.deployTask(new TaskGroupDefaultImpl("t1", Lists.newArrayList(t1)),
//                new CompletableFuture<Void>());
//
//        CompletableFuture<TaskExecutionState> t2c =
//            taskExecutionService.deployTask(new TaskGroupDefaultImpl("t2", Lists.newArrayList(t2)),
//                new CompletableFuture<Void>());
//
//        Thread.sleep(taskRunTime);
//
...
//            taskExecutionService.deployTask(taskGroup);
//
//        //stop tasks
//        Thread.sleep(taskRunTime);
//        stopMark.set(true);
...
//    }
//
//    public List<Task> buildFixedTestTask(long callTime, long count, AtomicBoolean stopMart,
...
//    }
//
//    public List<Task> buildStopTestTask(long callTime, long count, AtomicBoolean stopMart,
