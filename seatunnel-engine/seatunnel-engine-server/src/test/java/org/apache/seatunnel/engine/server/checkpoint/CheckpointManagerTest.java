...
class CheckpointManagerTest extends AbstractSeaTunnelServerTest {
    ...
    @Test
    void testHAByStateStoreCheckpointIDCounter() throws CheckpointStorageException {
        ...
        checkpointStorage.storeCheckPoint(
                PipelineState.builder()
                        ...
                        .build());
        StateStore<Integer, Long> checkpointIdMap =
                distributedStoreManager.getMap(String.format(IMAP_CHECKPOINT_ID, jobId));
        ...
        CheckpointManager checkpointManager =
                new CheckpointManager(
                        ...
                        distributedStoreManager.getMap(IMAP_RUNNING_JOB_STATE),
                        null);
