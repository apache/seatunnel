...
public class RemoveMetricsOperation extends TracingOperation implements IdentifiedDataSerializable {
    private PipelineLocation pipelineLocation;

    public RemoveMetricsOperation() {}

    public RemoveMetricsOperation(PipelineLocation pipelineLocation) {
