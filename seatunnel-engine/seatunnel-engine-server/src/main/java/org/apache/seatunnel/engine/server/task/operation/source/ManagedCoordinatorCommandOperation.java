...
/** Bounded admission adapter for Reader-to-coordinator managed Source commands. */
public class ManagedCoordinatorCommandOperation extends TaskOperation {
    private SourceCommandEnvelope command;
    private SourceCommandAdmissionAck response;

    public ManagedCoordinatorCommandOperation() {}
    ...
    public void runInternal() {
        try {
            ...
            response = task.admitManagedCoordinatorCommand(command);
        } catch (Exception e) {
            response =
                    SourceCommandAdmissionAck.of(
                            ...
                            -1L,
                            0L,
                            "Target Source coordinator is unavailable");
        }
    }
    ...
    public int getClassId() {
        return TaskDataSerializerHook.MANAGED_COORDINATOR_COMMAND_OPERATION;
    }
