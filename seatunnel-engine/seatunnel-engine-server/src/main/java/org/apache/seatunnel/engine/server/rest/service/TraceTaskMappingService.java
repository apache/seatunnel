...
/** Exposes the task mapping payload used by the stain trace UI and diagnostic endpoints. */
public class TraceTaskMappingService extends BaseService {
    ...
    /** Reads the mapping locally when possible and falls back to a master operation otherwise. */
