 ...
 *
 * <p>This interface is intended for states with explicit increment/decrement semantics, such as
 * checkpoint ID counters or reference counters, instead of exposing a generic {@code compute()}
 * operation.
 *
 * @param <K> key type
 */
