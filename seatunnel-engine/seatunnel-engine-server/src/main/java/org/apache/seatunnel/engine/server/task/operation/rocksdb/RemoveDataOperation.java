...
public class RemoveDataOperation<K> extends TracingOperation implements IdentifiedDataSerializable {
    private String stateName;
    private K key;

    public RemoveDataOperation() {}

    public RemoveDataOperation(String stateName, K key) {
    ...
    public void runInternal() throws Exception {
        ...
        seaTunnelServer.getRocksDBService().removeData(stateName, key);
    }
    ...
    public int getClassId() {
        return TaskDataSerializerHook.REMOVE_DATA_OPERATION;
    }
}
