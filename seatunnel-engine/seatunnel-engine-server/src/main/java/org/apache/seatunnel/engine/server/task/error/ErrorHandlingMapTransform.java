...
@Slf4j
public class ErrorHandlingMapTransform<T> implements SeaTunnelMapTransform<T> {

    private final SeaTunnelMapTransform<T> delegate;
    private final ErrorHandler<T> errorHandler;
    private final RowErrorClassifier<T> rowErrorClassifier;

    public ErrorHandlingMapTransform(
            SeaTunnelMapTransform<T> delegate,
