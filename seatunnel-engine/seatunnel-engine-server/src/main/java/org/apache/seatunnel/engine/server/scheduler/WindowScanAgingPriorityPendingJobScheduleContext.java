...
public class WindowScanAgingPriorityPendingJobScheduleContext
        extends AbstractPendingJobScheduleContext {
    public WindowScanAgingPriorityPendingJobScheduleContext(
    ...
    public WindowScanAgingPriorityConfig getConfig() {
        ...
        return config == null ? new WindowScanAgingPriorityConfig() : config;
    }
}
