...
/** Engine identity and ordering metadata for one reader-owned CDC progress report. */
public final class CdcReaderProgressEnvelope implements Serializable {
    ...
    private final CdcReaderProgressReport report;

    public CdcReaderProgressEnvelope(
    ...
    public CdcReaderProgressReport getReport() {
        return report;
    }
}
