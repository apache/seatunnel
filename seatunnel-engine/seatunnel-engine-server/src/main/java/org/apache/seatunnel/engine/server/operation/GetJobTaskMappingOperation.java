...
/** Master operation that returns the runtime task-to-vertex mapping for one job. */
public class GetJobTaskMappingOperation extends Operation
    ...
    /**
     * Builds the mapping on the receiving member so REST callers can retrieve the latest topology.
     */
    @Override
    public void run() {
