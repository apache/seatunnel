...
public class JsonConverterConfig extends ConverterConfig {
    ...
    /**
     * Upstream change from Kafka Connect 3.9.0 (backported here so the runtime 3.2.0 class behaves
     * identically): whether a null field value is substituted with the schema default.
     */
    ...
    /**
     * Return whether null values are replaced with the schema default.
     *
     * @return true if replaced, or false otherwise
     */
