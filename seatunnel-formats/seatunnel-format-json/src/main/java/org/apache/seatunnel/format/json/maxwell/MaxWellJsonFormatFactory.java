...
public class MaxWellJsonFormatFactory
    ...
    public static final String IDENTIFIER = "maxwell_json";
    ...
    public SerializationFormat createSerializationFormat(TableFactoryContext context) {
        return new SerializationFormat() {
            ...
            public SerializationSchema createSerializationSchema() {
                return new MaxWellJsonSerializationSchema(null);
            }
        };
    }
    ...
    public DeserializationFormat createDeserializationFormat(TableFactoryContext context) {
        ...
        boolean ignoreParseErrors = MaxWellJsonFormatOptions.getIgnoreParseErrors(options);
        String databaseInclude = MaxWellJsonFormatOptions.getDatabaseInclude(options);
        String tableInclude = MaxWellJsonFormatOptions.getTableInclude(options);
