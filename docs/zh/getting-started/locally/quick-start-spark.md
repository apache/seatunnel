...
这篇更适合已经在使用 Spark 的团队。如果您只是第一次接触 SeaTunnel，建议先从 [SeaTunnel 引擎快速开始](quick-start-seatunnel-engine.md) 入手。
...
- 如果您想了解更多 SeaTunnel 运行在 Spark 上的说明，请参阅[基于 Spark 的 SeaTunnel](../../engines/spark.md)。
