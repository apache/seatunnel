...
- [x] [支持用户定义分割](../../concept/connector-v2-features.md)
...
| snapshot.split.column                          | String   | 否       | -       | 用于拆分快照数据的列。 **该列必须是唯一键（主键或唯一索引）**。 如果指定了非唯一列, 该配置将被忽略, SeaTunnel 会在内部自动选择合适的拆分列。                                                                                                                                                                                                                                                                                |
...
| common-options                                 |          | 否       | -       | 源插件通用参数，请参考 [源通用选项](../source-common-options.md) 获取详细信息。                                                                                                                                                                                                                                     |
