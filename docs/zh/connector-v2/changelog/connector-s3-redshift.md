...
| Change | Commit |
| --- | --- |
|[BugFix] Fix S3Redshift connector copy file to redshift but file not found bug (#4282)|https://github.com/apache/seatunnel/commit/bcac24ebfc|
|[Fix] [Bug] Fix S3RedShift is not correct with S3 (#4291)|https://github.com/apache/seatunnel/commit/7b72dd95a2|
...
|[Connector][Sink]Support load data to S3 then Copy to Redshift (#3736)|https://github.com/apache/seatunnel/commit/8ef080f200|
