...
|[improve] update Druid connector config option (#8594)|https://github.com/apache/seatunnel/commit/07a2288a2e|
...
|[Feature][Druid]Support multi table for druid sink (#7023)|https://github.com/apache/seatunnel/commit/476d492165|
|[Feature][Connector] Add druid sink connector (#6346)|https://github.com/apache/seatunnel/commit/d7fa9afdfe|
