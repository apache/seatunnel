...
|[Improve][Connector-V2][Sentry] Unified exception for sentry sink connector (#3513)|https://github.com/apache/seatunnel/commit/94b472b806|
...
|[Feature][Sentry Sink V2] Add Sentry Sink Option Rules (#3318)|https://github.com/apache/seatunnel/commit/850f483816|
...
| Change | Commit |
| --- | --- |
|[Feature][Connector-V2] Add sentry sink connector #2244 (#2584)|https://github.com/apache/seatunnel/commit/9fd40390a7|
