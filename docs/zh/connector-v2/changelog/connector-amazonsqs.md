...
|[improve] amazon sqs connector update (#8602)|https://github.com/apache/seatunnel/commit/c747e02a98|
...
|[Improve][Connector-V2] Change `amazonsqs` to `AmazonSqs` as connector identifier (#5742)|https://github.com/apache/seatunnel/commit/245705d0f7|
|[Feature] [Connector-V2] Add connector amazonsqs (#5367)|https://github.com/apache/seatunnel/commit/7f75a8eafd|
