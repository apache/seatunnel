...
获取所有节点jobId为`733584788375666689`的日志信息：`http://localhost:5801/logs/733584788375666689`
获取所有节点日志列表：`http://localhost:5801/logs`
获取日志文件内容：`http://localhost:5801/logs/job-898380162133917698.log`
