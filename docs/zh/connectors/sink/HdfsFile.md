...
| xml_root_tag                     | string  | 否    | RECORDS                                    | 仅当 file_format 为 xml 时使用，指定 XML 文件中根元素的标签名。                                                                                                                                                                                                                                                      |
| xml_row_tag                      | string  | 否    | RECORD                                     | 仅当 file_format 为 xml 时使用，指定 XML 文件中数据行的标签名。                                                                                                                                                                                                                                                      |
...
| sheet_max_rows                   | int     | 否    | 1048576                                    | 仅当 file_format 为 excel 时使用。单个 sheet 允许写入的最大行数。                                                                                                                                                                                                                                                   |
