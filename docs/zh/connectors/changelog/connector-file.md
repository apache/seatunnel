...
| --- | --- | --- |
|[Feature][Connector-V2] Support S3 source connectivity dry-run (#12242)|https://github.com/apache/seatunnel/commit/333913255|3.0.0|
...
|[Improve][Connector-V2][File] Migrate HDFS and S3 sink validation to declarative OptionRule (#11881)|https://github.com/apache/seatunnel/commit/5acb54618|3.0.0|
...
|[Fix][Connector-V2] Do not fail FTP listings on logout reset (#11695)|https://github.com/apache/seatunnel/commit/66214e460|3.0.0|
...
|[Fix][Connector-V2] Clean up stale SFTP pooled sessions (#11180)|https://github.com/apache/seatunnel/commit/b253248ab|3.0.0|
...
|[Fix][Connector-V2] Support SFTP keyfile option (#11078)|https://github.com/apache/seatunnel/commit/32f4ed380|3.0.0|
...
|[Fix][Connector-OBS] Upgrade okio to 3.6.0 to fix NoSuchFieldError: Companion (#10756)|https://github.com/apache/seatunnel/commit/85688b8fa|3.0.0|
