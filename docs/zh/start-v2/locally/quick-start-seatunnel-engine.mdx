...
## Step 4: 使用集群模式运行seatunnel程序

首先，使用默认集群名称运行一个seatunnel集群
<Tabs
    groupId="env-type"
    defaultValue="Unix/Linux"
    values={[
...
在windows操作系统下需要命令`wmic`,如果你的电脑上没有这个命令，请按照[这个](https://techcommunity.microsoft.com/blog/windows-itpro-blog/how-to-install-wmic-feature-on-demand-on-windows-11/4189530)文档来安装它.
