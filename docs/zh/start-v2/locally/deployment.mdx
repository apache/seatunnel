...
<TabItem value="winodws">

在Windows系统下，使用你喜欢的浏览器下载对应个文件，并解压。
</TabItem>
</Tabs>
...
如果您使用内置的SeaTunnel引擎（Zeta）来运行任务，则需要先部署SeaTunnel引擎服务。请参考[SeaTunnel 引擎快速开始](quick-start-seatunnel-engine.mdx)。
