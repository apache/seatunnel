...
|-------------------------------------------|-------|------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------|
| cluster_info                              | Gauge | **hazelcastVersion**, hazelcastVersion<br>,*master**, seatunnel master address                                                     | Cluster info                                                            |
| cluster_time                              | Gauge | **hazelcastVersion**, hazelcastVersion<br>,*version**, seatunnel version                                                           | Cluster time                                                            |
...
| jvm_info                                   | Gauge   | **runtime**, for example: "Java(TM) SE Runtime Environment"<br> **vendor**, for example: "Oracle Corporation"<br> **version** ,for example: "1.8.0_212-b10" | VM version info                                                                                        |
