...
Retrieve log information for the job with jobId `733584788375666689`: `http://localhost:5801/get-log?jobId=733584788375666689`  
Retrieve all log information: `http://localhost:5801/get-log`
