...
| username                              | String  | Yes      | default                                                                       | Timeplus user username.                                                                                                                                                                                                                                                |
| password                              | String  | Yes      | -                                                                             | User password. Empty string as the default value.                                                                                                                                                                                                                      |
...
| save_mode_create_template             | string  | no       | CREATE STREAM IF NOT EXISTS `${database}`.`${table_name}` (${rowtype_fields}) | Customize how to create the stream/table                                                                                                                                                                                                                               |
