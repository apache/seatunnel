...
All `changelog-producer` modes are currently supported. The default is `none`.</br>
...
#### The Piamon single table with the `changelog-producer` attribute is configured
