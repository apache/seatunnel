...
| schema_save_mode                      | enum    | no       | CREATE_SCHEMA_WHEN_NOT_EXIST               | Existing dir processing method                                                                                                                                                  |
| data_save_mode                        | enum    | no       | APPEND_DATA                                | Existing data processing method                                                                                                                                                 |
