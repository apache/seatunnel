...
| Change | Commit |
| --- | --- |
|[improve] google sheets options (#8922)|https://github.com/apache/seatunnel/commit/48ede612dc|
...
|[Improve][Connector-V2][GoogleSheets] Unified exception for GoogleSheets source connector (#3524)|https://github.com/apache/seatunnel/commit/eb42d629ad|
|[Feature][Connector-V2][Google Sheets] Add Google Sheets option rules (#3364)|https://github.com/apache/seatunnel/commit/da33f730ca|
|fix: schema get error (#3361)|https://github.com/apache/seatunnel/commit/fdaa85ed24|
|[Feature][Connector-V2][GoogleSheets] Support GoogleSheets Source (#3185)|https://github.com/apache/seatunnel/commit/60ecc6428b|
