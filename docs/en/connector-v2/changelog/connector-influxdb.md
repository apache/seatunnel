...
| Change | Commit |
| --- | --- |
|Support multi-table sink feature for influxdb (#6278)|https://github.com/apache/seatunnel/commit/56f13e920d|
...
| Change | Commit |
| --- | --- |
|[Feature][Connector-V2] Add influxDB connector source (#2697)|https://github.com/apache/seatunnel/commit/1d70ea3084|
