...
|[improve] update amazondynamodb connector (#8601)|https://github.com/apache/seatunnel/commit/a69efca0fd|
...
|[Improve] Code clean for AmazonDynamoDB connector (#5791)|https://github.com/apache/seatunnel/commit/a17dd7afc1|
...
| Change | Commit |
| --- | --- |
|[Bugfix][AmazonDynamoDB] Fix the problem that all table data cannot be obtained (#5146)|https://github.com/apache/seatunnel/commit/09995159a0|
