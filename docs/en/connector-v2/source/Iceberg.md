...
| filter                   | String  | no       | -                    | The where clause to filter the iceberg data. It mustn't contain the table name. For example: There is an iceberg table contains an `id` column with the `int` type, now we want to filter the data that `id`>100. Then you can input `id > 100`.                                                                                                                                                                                                                                                                                                                                                                       |
