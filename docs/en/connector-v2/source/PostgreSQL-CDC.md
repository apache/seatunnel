...
| snapshot.split.column                     | String   | No       | -        | The column used to split snapshot data. **Note, This column must be a unique key (Primary Key or Unique Index).** If a non-unique column is provided, the configuration is ignored and SeaTunnel automatically selects an appropriate split column internally.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
