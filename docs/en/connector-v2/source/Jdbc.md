...
| string_split_mode                          | String  | No       | -               | When set to "charsetBased", enables charset-based string splitting algorithm. The algorithm assumes characters of partition_column are within ASCII range 32-126, which covers most character-based splitting scenarios.                                                                                                                                                                                                                                                                                                                                                                                                                           |
| collate                                    | String  | No       | -               | Specifies the collation to use when string_split_mode is set to "charsetBased" and the table has a special collation. If not specified, the database's default collation will be used.                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
