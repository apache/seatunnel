...
If you use an OpenAI model, refer to the [OpenAI model catalog](https://developers.openai.com/api/docs/models)
and check the model's supported endpoints to confirm compatibility with `/v1/chat/completions`.
