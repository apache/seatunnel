...
If you want to use the Flink engine, you need helm
- [helm](https://helm.sh/docs/intro/quickstart/)
If you want to use the cluster mode of the Zeta engine, you need HDFS to save Checkpoint
...
```
Image `seatunnel:2.3.3` need to be present in the host (minikube) so that the deployment can take place.
    ...
    checkpoint:
      ...
      storage:
        ...
        plugin-config:
          ...
          storage.type: hdfs
          fs.defaultFS: file:///tmp/ # Change this to your HDFS address
```
