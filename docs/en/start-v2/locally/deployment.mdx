...
In windows environment, you can directly download through your favor browser.
Then unzip the tar.gz package.
...
```bash
call .\bin\install-plugin.cmd 2.3.10
```
</TabItem>
</Tabs>
...
If you use the builtin SeaTunnel Engine (Zeta) to run tasks, you need to deploy the SeaTunnel Engine service first. Refer to [Quick Start With SeaTunnel Engine](quick-start-seatunnel-engine.mdx).
