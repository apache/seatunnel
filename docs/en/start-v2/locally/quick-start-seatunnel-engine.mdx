...
Stop cluster in windows need `wmic` command, please flow [this guide](https://techcommunity.microsoft.com/blog/windows-itpro-blog/how-to-install-wmic-feature-on-demand-on-windows-11/4189530) to install it if your windows doesn't installed.
