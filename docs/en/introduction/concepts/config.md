...
in [Source of SeaTunnel](https://seatunnel.apache.org/docs/connectors/source/). Each source has its own specific parameters to define how to
...
in [Transform V2 of SeaTunnel](https://seatunnel.apache.org/docs/transforms/)
...
[Supported Sinks](https://seatunnel.apache.org/docs/connectors/sink/).
...
- Start write your own config file now, choose the [connector](https://seatunnel.apache.org/docs/connectors/source/) you want to use, and configure the parameters according to the connector's documentation.
