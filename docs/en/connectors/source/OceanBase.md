...
| partition_num                | Int        | No       | 10 | The number of partition count, only support positive integer. When reading by `table_path`, prefer `split.size` to control split size.                                                                                                                                |
