...
## Support Sybase Version

- Adaptive Server Enterprise 15.0 or later, and other TDS‑compatible databases
...
> 1. You need to ensure that the [jdbc driver jar package](https://mvnrepository.com/artifact/net.sourceforge.jtds/jtds) has been placed in directory `${SEATUNNEL_HOME}/plugins/`.

### For SeaTunnel Zeta Engine

> 1. You need to ensure that the [jdbc driver jar package](https://mvnrepository.com/artifact/net.sourceforge.jtds/jtds) has been placed in directory `${SEATUNNEL_HOME}/lib/`.
...
|------------|-----------------------------------------|----------------------------------------------|---------------------------------|-----------------------------------------------------------------------------------|
| Sybase     | Adaptive Server Enterprise 15.0+        | net.sourceforge.jtds.jdbc.Driver             | jdbc:jtds:sybase://localhost:5000/&lt;database&gt; | [Download](https://mvnrepository.com/artifact/net.sourceforge.jtds/jtds) |
...
> For example Sybase datasource: cp jtds-xxx.jar $SEATUNNEL_HOME/plugins/jdbc/lib/

## Data Type Mapping

|                         Sybase Data type                          | Seatunnel Data type |
|-------------------------------------------------------------------|----------------------|
| BIT                                                                | BOOLEAN              |
...
| REAL                                                               | FLOAT                |
| FLOAT                                                              | DOUBLE               |
| CHAR<br/>VARCHAR<br/>NCHAR<br/>NVARCHAR<br/>TEXT                   | STRING               |
| DATE                                                               | DATE                 |
| TIME                                                               | TIME                 |
| DATETIME<br/>SMALLDATETIME                                         | TIMESTAMP            |

## Source Options

|                    name                    | type   | required | default         |                                                                                                                                                                                                                                                                                                     Description                                                                                                                                                                                                                                                                                                      |
|--------------------------------------------|--------|----------|-----------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| url                                        | String | Yes      | -               | The URL of the JDBC connection. Refer to a case: jdbc:jtds:sybase://127.0.0.1:5000/master                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| driver                                     | String | Yes      | -               | The jdbc class name used to connect to the remote data source,<br/> if you use Sybase the value is `net.sourceforge.jtds.jdbc.Driver`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
...
source{
    Jdbc {
        ...
        username = "sa"
        password = "myPassword"
        query = "select * from dbo.full_types"
    }
}
