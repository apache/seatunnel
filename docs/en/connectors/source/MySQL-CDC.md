...
| schema-changes.behavior                   | Enum     | No       | evolve  | Controls how emitted schema change events are handled when `schema-changes.enabled = true`. Valid values are `strict`, `evolve`, and `ignore`. See [Schema change behavior](../../introduction/configuration/schema-evolution.md#schema-change-behavior).                                                                                                                                                                                                                                                                                                                                                              |
