...
| startup.specific-offset.file              | String   | No       | -       | Start from the specified binlog file name. This option must be used together with `startup.specific-offset.pos` when `startup.mode` is `specific`, and cannot be used together with `startup.specific-offset.gtid-set`.                                                                                                                                                                                                                                                                                                                                                                                              |
| startup.specific-offset.pos               | Long     | No       | -       | Start from the specified binlog file position. This option must be used together with `startup.specific-offset.file` when `startup.mode` is `specific`, and cannot be used together with `startup.specific-offset.gtid-set`.                                                                                                                                                                                                                                                                                                                                                                                          |
| startup.specific-offset.gtid-set          | String   | No       | -       | Start from the specified MySQL GTID set when `startup.mode` is `specific`. This option cannot be used together with `startup.specific-offset.file` or `startup.specific-offset.pos`.                                                                                                                                                                                                                                                                                                                                                                                                                                 |
