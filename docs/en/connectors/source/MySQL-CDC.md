...
| exactly_once                              | Boolean  | No       | false   | Enable exactly once semantics and bounded binlog backfill during the snapshot phase. Supported when `startup.mode` is `initial` or `snapshot`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
