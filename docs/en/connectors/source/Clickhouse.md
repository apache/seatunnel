...
| table_path        | String | No       | -                      | The full path of a single table to read, for example `default.table`. Configure exactly one of `table_path` (flattened for a single table) and `table_list`.                                                                                                                                                  |
