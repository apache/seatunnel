...
| startup.timestamp                         | Long     | No       | -       | Start from the specified timestamp (milliseconds since Unix epoch). **Note, This option is required when the `startup.mode` option used `timestamp`.**                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
