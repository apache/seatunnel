...
| stop.mode                                 | Enum     | No        | NEVER   | Optional stop mode for Oracle CDC consumer, valid enumeration is `never`. <br/> `never`: Real-time job doesn't stop the source.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
