...
| driver                                     | String     | Yes      | -               | The JDBC class name used to connect to PostgreSQL. The value is `org.postgresql.Driver`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| username                                       | String     | No       | -               | Connection instance user name                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| password                                   | String     | No       | -               | Connection instance password                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| query                                      | String     | Yes      | -               | Query statement                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| connection_check_timeout_sec               | Int        | No       | 30              | The time in seconds to wait for the database operation used to validate the connection to complete                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| partition_column                           | String     | No       | -               | Column used for parallel read splitting. Configure only one column. PostgreSQL supports numeric, string, and date/time split columns through the shared JDBC splitter.                                                                                                                                                                                                                                                                                                                                                                                                                                                |
...
| split.string_split_mode                    | Enum       | No       | sample          | String split algorithm. `sample` splits by sampling string values. `charset_based` assumes the split column uses printable ASCII characters.                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| split.string-strategy                      | Enum       | No       | -               | Strategy for String partition columns. `range` uses range splitting, `hash` uses hash splitting, `none` disables String splitting, and `auto` tries range first and falls back to hash when needed.                                                                                                                                                                                                                                                                                                                                                                                                                    |
| split.string_split_mode_collate            | String     | No       | -               | Collation used when `split.string_split_mode = charset_based` and the table has a special collation. If not set, the database default collation is used.                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
