...
> To use this connector you need put hadoop-aws-3.1.4.jar and aws-java-sdk-bundle-1.12.770.jar in ${SEATUNNEL_HOME}/lib dir.
...
| fs.s3a.aws.credentials.provider | string  | yes      | com.amazonaws.auth.InstanceProfileCredentialsProvider | The way to authenticate s3a. Supported providers: `org.apache.hadoop.fs.s3a.SimpleAWSCredentialsProvider` (static access key / secret key), `com.amazonaws.auth.InstanceProfileCredentialsProvider` (EC2 instance profile), `com.amazonaws.auth.WebIdentityTokenCredentialsProvider` (Kubernetes IRSA), `com.amazonaws.auth.DefaultAWSCredentialsProviderChain` (automatic chain, recommended). More information about the credential provider you can see [Hadoop AWS Document](https://hadoop.apache.org/docs/stable/hadoop-aws/tools/hadoop-aws/index.html#Simple_name.2Fsecret_credentials_with_SimpleAWSCredentialsProvider.2A) |
