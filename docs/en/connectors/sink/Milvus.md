...
| enable_nullable_field  | boolean             | No       | false                        | Enable nullable fields. When enabled, SeaTunnel creates the field as a Milvus nullable field and allows writing `null` values when the SeaTunnel column is nullable and the field is used as a Milvus scalar field. |
