...
| file_format_type                 | string  | no       | csv                                                       | File format written to S3. Supported values: `text`, `csv`, `parquet`, `orc`, `json`. The final file name ends with the corresponding suffix (e.g. `txt` for text).                                                       |
