...
- [配置](/zh-cn/configuration/base)
  ...
  - [Input插件](/zh-cn/configuration/input-plugin)
    - [AmazonKinesis [商业版]](/zh-cn/configuration/AmazonKinesis)
    ...
    - [MongoDBOplogStream [商业版]](/zh-cn/configuration/MongoDBOplogStream)
    ...
    - [阿里云DTS [商业版]](/zh-cn/configuration/AliyunDts)
    - [阿里云SLS [商业版]](/zh-cn/configuration/AliyunSls)
