...
public class InternalParallelBatchSource<SplitT extends SourceSplit, StateT extends Serializable>
        extends ParallelSource<SeaTunnelRow, SplitT, StateT> {

    private final ParallelBatchPartitionReader parallelBatchPartitionReader;

    public InternalParallelBatchSource(
            ParallelBatchPartitionReader parallelBatchPartitionReader,
