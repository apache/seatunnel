...
public class CaseInsensitiveStringMap implements Map<String, String>, Serializable {
    ...
    /**
     * Returns the boolean value to which the specified key is mapped, or defaultValue if there is
     * no mapping for the key. The key match is case-insensitive.
     */
    ...
    /**
     * Returns the integer value to which the specified key is mapped, or defaultValue if there is
     * no mapping for the key. The key match is case-insensitive.
     */
