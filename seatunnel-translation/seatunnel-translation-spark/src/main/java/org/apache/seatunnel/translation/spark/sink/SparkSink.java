...
public class SparkSink<InputT, StateT, CommitInfoT, AggregatedCommitInfoT> implements WriteSupport, StreamWriteSupport {

    private final Sink<InputT, StateT, CommitInfoT, AggregatedCommitInfoT> sink;
    private final Map<String, String> configuration;

    SparkSink(Sink<InputT, StateT, CommitInfoT, AggregatedCommitInfoT> sink, Map<String, String> configuration) {
        this.sink = sink;
