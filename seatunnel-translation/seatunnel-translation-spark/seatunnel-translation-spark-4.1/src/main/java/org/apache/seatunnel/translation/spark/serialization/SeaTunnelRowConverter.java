...
public class SeaTunnelRowConverter extends RowConverter<GenericRow> {
    ...
    private scala.collection.immutable.Map<Object, Object> convertMap(
    ...
    private Object[] convertArray(Object[] arrayData, ArrayType<?, ?> arrayType) {
        ...
        switch (dataType.getSqlType()) {
            ...
            case ARRAY:
                if (field instanceof Object[]) {
                    return reconvertArray((Object[]) field, (ArrayType<?, ?>) dataType);
                }
                if (field instanceof scala.collection.IndexedSeq) {
    ...
    private Object reconvertArray(Object[] arrayData, ArrayType<?, ?> arrayType) {
    ...
    private Object[] indexedSeqToArray(scala.collection.IndexedSeq<?> seq) {
