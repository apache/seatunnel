...
package org.apache.seatunnel.flink.socket.connector.socket.table;

import org.apache.seatunnel.flink.socket.connector.socket.source.SocketDynamicTableSource;
...
public final class SocketDynamicTableFactory implements DynamicTableSourceFactory {
    ...
    public String factoryIdentifier() {
        return "seatunnel-socket"; // used for matching to `connector = '...'`
    }
