...
public class KafkaSourceMetaToConsoleIT extends KafkaTestBaseIT{
    ...
    public void testKafkaSourceJsonToConsole() throws IOException, InterruptedException {
        Container.ExecResult execResult = executeSeaTunnelSparkJob("/kafka/kafkasource_meta_to_console.conf");
