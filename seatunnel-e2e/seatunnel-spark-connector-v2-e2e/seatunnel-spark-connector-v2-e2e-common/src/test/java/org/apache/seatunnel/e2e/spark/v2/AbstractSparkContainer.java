...
<<<<<<< HEAD
<<<<<<< HEAD:seatunnel-e2e/seatunnel-spark-connector-v2-e2e/connector-spark-e2e-base/src/test/java/org/apache/seatunnel/e2e/spark/SparkContainer.java
...
=======
    protected static final Path PROJECT_ROOT_PATH = Paths.get(System.getProperty("user.dir")).getParent()
            .getParent().getParent();
    protected static final String SEATUNNEL_SPARK_BIN = "start-seatunnel-spark-new-connector.sh";
>>>>>>> 04bcb339 (add e2e for spark3.3):seatunnel-e2e/seatunnel-spark-connector-v2-e2e/seatunnel-spark-connector-v2-e2e-common/src/test/java/org/apache/seatunnel/e2e/spark/v2/AbstractSparkContainer.java
=======
    protected static final Path PROJECT_ROOT_PATH = Paths.get(System.getProperty("user.dir")).getParent()
            .getParent().getParent();
    protected static final String SEATUNNEL_SPARK_BIN = "start-seatunnel-spark-new-connector.sh";
>>>>>>> 34e5b5c4 (add e2e for spark3.3)
    private static final String SEATUNNEL_SPARK_JAR = "seatunnel-spark-starter.jar";
    private static final String PLUGIN_MAPPING_FILE = "plugin-mapping.properties";
    protected static final String SEATUNNEL_HOME = "/tmp/spark/seatunnel";
    private static final String SEATUNNEL_BIN = Paths.get(SEATUNNEL_HOME, "bin").toString();
    private static final String STARTER_JAR_PATH = Paths.get(SEATUNNEL_HOME, "lib",
            "seatunnel-spark-starter.jar").toString();
    ...
    protected abstract String getTranslationJarPath();

    protected abstract String getTranslationJarTargetPath();

    protected abstract String getSparkDockerImage();

    @BeforeEach
    public void before() {
        master = new GenericContainer<>(getSparkDockerImage())
            .withNetwork(NETWORK)
    ...
    protected void copySeaTunnelSparkFile() {
        ...
        master.copyFileToContainer(MountableFile.forHostPath(seatunnelCoreSparkJarPath), STARTER_JAR_PATH);
        ...
        // copy lib
        String translationSparkJarPath = getTranslationJarPath();
        master.copyFileToContainer(MountableFile.forHostPath(translationSparkJarPath), getTranslationJarTargetPath());
