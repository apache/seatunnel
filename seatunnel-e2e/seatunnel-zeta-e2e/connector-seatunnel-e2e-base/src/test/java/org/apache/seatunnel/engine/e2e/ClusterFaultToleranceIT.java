...
package org.apache.seatunnel.zeta.e2e;
...
import org.apache.seatunnel.zeta.client.SeaTunnelClient;
import org.apache.seatunnel.zeta.client.job.ClientJobProxy;
import org.apache.seatunnel.zeta.client.job.JobExecutionEnvironment;
import org.apache.seatunnel.zeta.common.config.ConfigProvider;
import org.apache.seatunnel.zeta.common.config.JobConfig;
import org.apache.seatunnel.zeta.common.config.SeaTunnelConfig;
import org.apache.seatunnel.zeta.core.job.JobStatus;
import org.apache.seatunnel.zeta.server.SeaTunnelServerStarter;
...
public class ClusterFaultToleranceIT {
    ...
    public void testBatchJobRunOkIn3Node() throws ExecutionException, InterruptedException {
        ...
        SeaTunnelClient zetaClient = null;
        ...
        try {
            ...
            zetaClient = new SeaTunnelClient(clientConfig);
            JobExecutionEnvironment jobExecutionEnv =
                zetaClient.createExecutionContext(testResources.getRight(), jobConfig);
            ...
            System.out.println(zetaClient.getJobMetrics(clientJobProxy.getJobId()));
        } finally {
            if (zetaClient != null) {
                zetaClient.shutdown();
            }
    ...
    public void testStreamJobRestoreInAllNodeDown() throws ExecutionException, InterruptedException {
        ...
        try {
            String yaml = "#\n" +
                ...
                "        enabled: true\n" +
                "        initial-mode: EAGER\n" +
                "        factory-class-name: org.apache.seatunnel.zeta.server.persistence.FileMapStoreFactory\n" +
                "        properties:\n" +
