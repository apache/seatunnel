...
package org.apache.seatunnel.e2e.container.mongdb;
...
public class MongodbContainer {
    ...
    private static final String MONGODB_CONTAINER_HOST = "seatunnel_mongodb";
    ...
    public static final List<Document> TEST_DATASET = generateTestDataSet();

    private GenericContainer<?> mongodbContainer;
    private MongoClient client;

    private static final Long LEAST_TIMEOUT = 100L;
    private static final Long MOST_TIMEOUT = 180L;
    private static final Long POLL_INTERVAL = 500L;

    private static final int DATASET_ROW_NUM = 100;

    public void startMongoContainer(Network network) {
        ...
        Awaitility.given().ignoreExceptions()
            .atLeast(LEAST_TIMEOUT, TimeUnit.MILLISECONDS)
            .pollInterval(POLL_INTERVAL, TimeUnit.MILLISECONDS)
            .atMost(MOST_TIMEOUT, TimeUnit.SECONDS)
    ...
    private void initConnection() {
        ...
        LOG.info("The mongodb url is {}.", url);
    ...
    private void initSourceData() {
        ...
        LOG.info("Inserted data set successfully!");
    }

    public List<Document> readSinkData() {
    ...
    private static List<Document> generateTestDataSet() {
        ...
        SeaTunnelDataType[] fieldTypes = new SeaTunnelDataType[]{BasicType.LONG_TYPE,
        ...
        List<Document> documents = new ArrayList<>();
        for (int i = 0; i < DATASET_ROW_NUM; i++) {
            SeaTunnelRow row = new SeaTunnelRow(
                new Object[]{
                    Long.valueOf(i),
                    Collections.singletonMap("key", Short.parseShort("1")),
                    new Byte[]{Byte.parseByte("1")}, "string", Boolean.FALSE,
                    Byte.parseByte("1"),
                    Short.parseShort("1"),
                    Integer.parseInt("1"),
                    Long.parseLong("1"),
