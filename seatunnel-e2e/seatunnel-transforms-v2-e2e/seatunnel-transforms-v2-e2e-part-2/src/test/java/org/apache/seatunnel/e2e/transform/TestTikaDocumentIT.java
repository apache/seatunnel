...
public class TestTikaDocumentIT extends TestSuiteBase {
    ...
    public void testTikaDocumentTransform(TestContainer container)
        ...
        Container.ExecResult execResult = container.executeJob("/tikadocument_transform.conf");
        Assertions.assertEquals(0, execResult.getExitCode());
    }

    @TestTemplate
    public void testTikaDocumentTransformMultiTable(TestContainer container)
            throws IOException, InterruptedException {
