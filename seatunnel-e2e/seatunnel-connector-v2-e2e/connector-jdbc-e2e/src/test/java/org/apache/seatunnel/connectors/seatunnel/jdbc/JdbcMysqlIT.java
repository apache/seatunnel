...
public class JdbcMysqlIT extends AbstractJdbcIT {
    ...
    private static final String CONFIG_FILE = "/jdbc_mysql_source_and_sink.conf";
    private static final String CREATE_SQL = "CREATE TABLE IF NOT EXISTS %s\n" +
        "(\n" +
    ...
    protected GenericContainer<?> initContainer() {
        ...
        GenericContainer<?> container = new MySQLContainer<>(imageName)
            ...
            .withLogConsumer(new Slf4jLogConsumer(DockerLoggerFactory.getLogger(MYSQL_IMAGE)));

        container.setPortBindings(Lists.newArrayList(String.format("%s:%s", MYSQL_PORT, MYSQL_PORT)));
