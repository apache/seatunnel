...
public class JdbcSybaseIT extends AbstractJdbcIT {
    ...
    private static final String SYBASE_IMAGE = "nguoianphu/docker-sybase";
    ...
    private static final List<String> CONFIG_FILE =
            Lists.newArrayList("/jdbc_sybase_source_to_sink.conf");
    ...
    JdbcCase getJdbcCase() {
        ...
        String insertSql = insertTable("", SYBASE_SOURCE, fieldNames);
            ...
            SeaTunnelRow row =
                    new SeaTunnelRow(
                            new Object[] {
                                ...
                                2.71f, // REAL_TEST
                                LocalDateTime.now().withNano(0), // SMALLDATETIME_TEST
                ...
                new GenericContainer<>(DockerImageName.parse(SYBASE_IMAGE))
                        ...
                        .withLogConsumer(
                                new Slf4jLogConsumer(
                                        DockerLoggerFactory.getLogger(SYBASE_IMAGE)));

        container.setPortBindings(
                Lists.newArrayList(
                        String.format(
                                "%s:%s", SYBASE_CONTAINER_PORT, SYBASE_CONTAINER_PORT)));
