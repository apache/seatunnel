...
/**
 * Abstract base class for Hive auto create table E2E tests. Provides common functionality for MySQL
 * connection, data type mapping verification, and Hive table validation.
 */
@Slf4j
public abstract class AbstractHiveAutoCreateIT {
    ...
    protected static Connection initializeMySQLConnection() throws Exception {
        ...
        Connection connection =
                DriverManager.getConnection(mysqlUrl, MYSQL_USERNAME, MYSQL_PASSWORD);
    ...
    protected void verifyTypeConversion(String mysqlType, String expectedHiveType) {
        ...
        if (!expectedHiveType.equals(actualHiveType)) {
            log.error(
                    "Type conversion mismatch - MySQL: {}, Expected Hive: {}, Actual: {}",
                    mysqlType,
                    expectedHiveType,
                    actualHiveType);
        } else {
    ...
    protected void verifyHiveTableSchema(
            String database, String table, Map<String, String> expectedColumns) {
    ...
    protected void verifyHiveTableProperties(
            String database, String table, Map<String, String> expectedProperties) {
