...
/**
 * MySQL container wrapper for e2e.
 *
 * <p>Do not use {@code org.testcontainers.containers.MySQLContainer} here because older
 * testcontainers may append unsupported args (e.g. --skip-host-cache) for MySQL 8.4.
 */
