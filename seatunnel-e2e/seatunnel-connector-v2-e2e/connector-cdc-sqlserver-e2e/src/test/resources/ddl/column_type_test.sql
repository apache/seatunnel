...
INSERT INTO full_types_2 VALUES (0,
                                 'cč0', 'vcč', 'tč', N'cč', N'vcč', N'tč',
                                 1.123, 2, 3.323, 4.323, 5.323, 6.323,
                                 1, 22, 333, 4444, 55555,
                                 '2018-07-13', '10:23:45', '2018-07-13 11:23:45.34', '2018-07-13 13:23:45.78', '2018-07-13 14:23:45',
                                 '<a>b</a>',SYSDATETIMEOFFSET(),CAST('test_varbinary' AS varbinary(100)), 5.32);
INSERT INTO full_types_2 VALUES (1,
                                 'cč1', 'vcč', 'tč', N'cč', N'vcč', N'tč',
                                 1.123, 2, 3.323, 4.323, 5.323, 6.323,
                                 1, 22, 333, 4444, 55555,
                                 '2018-07-13', '10:23:45', '2018-07-13 11:23:45.34', '2018-07-13 13:23:45.78', '2018-07-13 14:23:45',
                                 '<a>b</a>',SYSDATETIMEOFFSET(),CAST('test_varbinary' AS varbinary(100)), 5.32);
INSERT INTO full_types_2 VALUES (2,
                                 'cč2', 'vcč', 'tč', N'cč', N'vcč', N'tč',
                                 1.123, 2, 3.323, 4.323, 5.323, 6.323,
                                 1, 22, 333, 4444, 55555,
                                 '2018-07-13', '10:23:45', '2018-07-13 11:23:45.34', '2018-07-13 13:23:45.78', '2018-07-13 14:23:45',
                                 '<a>b</a>',SYSDATETIMEOFFSET(),CAST('test_varbinary' AS varbinary(100)), 5.32);
EXEC sys.sp_cdc_enable_table @source_schema = 'dbo', @source_name = 'full_types_2', @role_name = NULL, @supports_net_changes = 0;
...
CREATE TABLE sink_full_types_2 (
                            id int NOT NULL,
                            val_char char(3),
                            val_varchar varchar(1000),
                            val_text text,
