...
create table "debezium_lowercase.full_types_lowercase" (
...
ALTER TABLE "debezium_lowercase.full_types_lowercase" ADD SUPPLEMENTAL LOG DATA (ALL) COLUMNS;

INSERT INTO "debezium_lowercase.full_types_lowercase" VALUES (
    1, 'vc2', 'vc2', 'nvc2', 'c', 'nc',
...
create table "debezium_lowercase.sink_full_types_lowercase" (
                                          ID                           NUMBER(9) not null,
                                          VAL_VARCHAR                  VARCHAR2(1000),
                                          VAL_VARCHAR2                 VARCHAR2(1000),
                                          VAL_NVARCHAR2                NVARCHAR2(1000),
