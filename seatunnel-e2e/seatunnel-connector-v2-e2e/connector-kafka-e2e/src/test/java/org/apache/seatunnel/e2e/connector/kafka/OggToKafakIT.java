...
public class OggToKafakIT extends TestSuiteBase implements TestResource {

    private static final Logger LOG = LoggerFactory.getLogger(OggToKafakIT.class);

    private static GenericContainer<?> CANAL_CONTAINER;

    //    private static final String CANAL_DOCKER_IMAGE = "chinayin/canal:1.1.6";

    private static final String OGG_HOST = "ogg_e2e";
    ...
    private static final String KAFKA_TOPIC = "test-ogg-sink";
    ...
    // ----------------------------------------------------------------------------
    // ogg
    private static final String DOCKER_OGG_IMAGE_NAME = "iatebes/oracle_11g:latest";

    private void createOggContainer() {
        CANAL_CONTAINER =
                new GenericContainer<>(DOCKER_OGG_IMAGE_NAME)
                        ...
                        .withNetwork(NETWORK)
                        .withNetworkAliases(OGG_HOST)
                        .withCommand()
                        .withLogConsumer(
                                new Slf4jLogConsumer(
                                        DockerLoggerFactory.getLogger(DOCKER_OGG_IMAGE_NAME)));
    ...
    private final UniqueDatabase inventoryDatabase =
            new UniqueDatabase(MYSQL_CONTAINER, "ogg", "mysqluser", "mysqlpw");
    ...
    public void startUp() throws ClassNotFoundException {
        ...
        LOG.info("The third stage: Starting Ogg containers...");
