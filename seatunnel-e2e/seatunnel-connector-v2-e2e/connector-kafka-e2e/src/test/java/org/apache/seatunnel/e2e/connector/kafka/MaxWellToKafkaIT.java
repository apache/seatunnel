...
public class MaxWellToKafkaIT extends TestSuiteBase implements TestResource {
    ...
    private static GenericContainer<?> MAXWELL_CONTAINER;
    ...
    private void createMaxWellContainer() {
        MAXWELL_CONTAINER =
                new GenericContainer<>(MAXWELL_DOCKER_IMAGE)
    ...
    public void startUp() throws ClassNotFoundException, InterruptedException {
        ...
        LOG.info("The third stage: Starting Maxwell containers...");
        createMaxWellContainer();
        Startables.deepStart(Stream.of(MAXWELL_CONTAINER)).join();
        LOG.info("Maxwell Containers are started");
