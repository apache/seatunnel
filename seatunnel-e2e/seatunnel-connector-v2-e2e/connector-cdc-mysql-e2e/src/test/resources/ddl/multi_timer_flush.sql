...
-- Source and sink tables used by multi-table engine-level timer flush E2E tests.
-- Two source tables in mysql_cdc, two sink tables in mysql_cdc2 (same schema).
...
-- ----------------------------------------------------------------------------------------------------------------
-- Source table 1: timer_flush_src
-- ----------------------------------------------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS timer_flush_src
(
...
INSERT INTO timer_flush_src ( id, f_binary, f_blob, f_long_varbinary, f_longblob, f_tinyblob, f_varbinary, f_smallint,
...
-- ----------------------------------------------------------------------------------------------------------------
-- Source table 2: timer_flush_src_2
-- ----------------------------------------------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS timer_flush_src_2 LIKE timer_flush_src;

truncate table timer_flush_src_2;

INSERT INTO timer_flush_src_2 ( id, f_binary, f_blob, f_long_varbinary, f_longblob, f_tinyblob, f_varbinary, f_smallint,
                          f_smallint_unsigned, f_mediumint, f_mediumint_unsigned, f_int, f_int_unsigned, f_integer,
                          f_integer_unsigned, f_bigint, f_bigint_unsigned, f_numeric, f_decimal, f_float, f_double,
                          f_double_precision, f_longtext, f_mediumtext, f_text, f_tinytext, f_varchar, f_date, f_datetime,
                          f_timestamp, f_bit1, f_bit64, f_char, f_enum, f_mediumblob, f_long_varchar, f_real, f_time,
...
-- ----------------------------------------------------------------------------------------------------------------
-- Sink tables in mysql_cdc2 (same schema as source, timer flush writes here)
-- ----------------------------------------------------------------------------------------------------------------
CREATE DATABASE IF NOT EXISTS `mysql_cdc2`;

use mysql_cdc2;

CREATE TABLE IF NOT EXISTS timer_flush_src LIKE mysql_cdc.timer_flush_src;
truncate table timer_flush_src;

CREATE TABLE IF NOT EXISTS timer_flush_src_2 LIKE mysql_cdc.timer_flush_src_2;
truncate table timer_flush_src_2;
