...
drop table if exists mysql_cdc_e2e_sink_table_with_truncate;
CREATE TABLE if not exists mysql_cdc_e2e_sink_table_with_truncate (
 id INTEGER NOT NULL AUTO_INCREMENT PRIMARY KEY,
 name VARCHAR(255) NOT NULL DEFAULT 'SeaTunnel',
 description VARCHAR(512),
 weight FLOAT
...
drop table if exists mysql_cdc_e2e_sink_table_with_truncate_disabled;
CREATE TABLE if not exists mysql_cdc_e2e_sink_table_with_truncate_disabled (
 id INTEGER NOT NULL AUTO_INCREMENT PRIMARY KEY,
 name VARCHAR(255) NOT NULL DEFAULT 'SeaTunnel',
 description VARCHAR(512),
 weight FLOAT
