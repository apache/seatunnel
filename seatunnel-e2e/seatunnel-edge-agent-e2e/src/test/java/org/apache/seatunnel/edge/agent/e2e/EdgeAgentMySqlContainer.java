...
public class EdgeAgentMySqlContainer extends JdbcDatabaseContainer<EdgeAgentMySqlContainer> {
    ...
    public EdgeAgentMySqlContainer(String version) {
    ...
    public EdgeAgentMySqlContainer withConfigurationOverride(String path) {
        parameters.put(MY_CNF_CONFIG_OVERRIDE_PARAM_NAME, path);
        return this;
    }

    public EdgeAgentMySqlContainer withSetupSQL(String sqlPath) {
        parameters.put(SETUP_SQL_PARAM_NAME, sqlPath);
        return this;
    }

    @Override
    public EdgeAgentMySqlContainer withDatabaseName(String databaseName) {
        this.databaseName = databaseName;
        return this;
    }

    @Override
    public EdgeAgentMySqlContainer withUsername(String username) {
        this.username = username;
        return this;
    }

    @Override
    public EdgeAgentMySqlContainer withPassword(String password) {
