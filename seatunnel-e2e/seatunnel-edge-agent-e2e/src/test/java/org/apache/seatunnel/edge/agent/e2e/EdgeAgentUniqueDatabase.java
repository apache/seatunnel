...
public class EdgeAgentUniqueDatabase {

    private static final Logger LOG = LoggerFactory.getLogger(EdgeAgentUniqueDatabase.class);
    ...
    private final EdgeAgentMySqlContainer container;
    private final String databaseName;
    private final String username;
    private final String password;
    private String templateName;

    public EdgeAgentUniqueDatabase(
            EdgeAgentMySqlContainer container,
            String databaseName,
            String username,
            String password,
            String templateName) {
    ...
    public EdgeAgentUniqueDatabase setTemplateName(String templateName) {
        this.templateName = templateName;
        return this;
    }
    ...
    public void createAndInitialize() {
        ...
        final URL ddlTestFile = EdgeAgentUniqueDatabase.class.getClassLoader().getResource(ddlFile);
