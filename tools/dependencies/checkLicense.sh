...
./mvnw clean -pl '!seatunnel-connectors-v2-dist,!seatunnel-dist' --batch-mode  --no-snapshot-updates dependency:copy-dependencies -DincludeScope=runtime -DoutputDirectory=/tmp/seatunnel-dependencies
