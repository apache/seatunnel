...
public class Fake extends BaseSparkBatchSource {
    @Override
    public Dataset<Row> getData(SparkEnvironment env) {
        List<Row> s = Lists.newArrayList(RowFactory.create("Hello garyelephant"),
        ...
        return env.getSparkSession().createDataFrame(s, schema);
    }
