...
public abstract class AbstractFlinkExecution implements TaskExecution {
    ...
    protected final PluginExecuteProcessor<DataStreamTableInfo, FlinkRuntimeEnvironment>
    ...
    protected Config registerPlugin(Config config, List<URL> jars) {
        config =
    ...
    protected Config injectJarsToConfig(Config config, String path, List<URL> jars) {
