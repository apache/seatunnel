...
public class FlinkStarterArgsTest {
    ...
    public void testUserDefinedParamsCommand() throws URISyntaxException {
        ...
        URL resource =
                FlinkStarterArgsTest.class.getResource("/args/user_defined_params_flink.conf");
