...
public class EnvironmentInformation {
    ...
    private static final int PHYSICAL_MEM_RATIO = 4;
    private static final int MAX_HEAP_MEM_RIGHT_BIT = 20;
    ...
    /**
     * Returns the code revision (commit and commit date) of SeaTunnel, as generated by the Maven
     * builds.
     *
    ...
    public static long getMaxJvmHeapMemory() {
        ...
        if (maxMemory != Long.MAX_VALUE) {
            ...
            if (physicalMemory != -1) {
                ...
                return physicalMemory / PHYSICAL_MEM_RATIO;
            } else {
    ...
    public static void logEnvironmentInfo(
        ...
        if (log.isInfoEnabled()) {
            ...
            String inheritedLogs = System.getenv("SEATUNNEL_INHERITED_LOGS");

            long maxHeapMegabytes = getMaxJvmHeapMemory() >>> MAX_HEAP_MEM_RIGHT_BIT;
    ...
    private static final class Versions {
        ...
        private static final String PROP_FILE = ".seatunnel-starter.version.properties";

        private static final String FAIL_MESSAGE =
                "The file "
                        + PROP_FILE
                        + " has not been generated correctly. You MUST run 'mvn generate-sources' in the seatunnel-starter module.";
        ...
        public Versions() {
            ...
            try (InputStream propFile = classLoader.getResourceAsStream(PROP_FILE)) {
                if (propFile != null) {
                    ...
                    // Default format is in Berlin timezone because that is where SeaTunnel originated.
    ...
    /**
     * Revision information encapsulates information about the source code revision of the SeaTunnel
     * code.
     */
