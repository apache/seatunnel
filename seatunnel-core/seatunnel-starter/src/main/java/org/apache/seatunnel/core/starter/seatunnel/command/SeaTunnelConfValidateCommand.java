...
public class SeaTunnelConfValidateCommand implements Command<ClientCommandArgs> {
    ...
    public void execute() throws ConfigCheckException {
        ...
        try {
            ...
            validatePluginConfigs(sourceConfigs, TableSourceFactory.class);
            validatePluginConfigs(transformConfigs, TableTransformFactory.class);
            validatePluginConfigs(sinkConfigs, TableSinkFactory.class);
    ...
    private void validatePluginConfigs(
            List<? extends Config> pluginConfigs, Class<? extends Factory> factoryClass)
        ...
        for (Config pluginConfig : pluginConfigs) {
            ...
            Factory factory = FactoryUtil.discoverFactory(classLoader, factoryClass, pluginName);
            ...
            if ("Sql".equalsIgnoreCase(pluginName)
                ...
                validateSqlTransformSyntax(pluginConfig, classLoader);
            }
        }
    }
