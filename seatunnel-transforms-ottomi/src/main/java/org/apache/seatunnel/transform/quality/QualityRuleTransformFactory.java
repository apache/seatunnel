...
import static org.apache.seatunnel.transform.quality.QualityRuleTransform.PLUGIN_NAME;

@AutoService(Factory.class)
public class QualityRuleTransformFactory implements TableTransformFactory {
    @Override
    ...
    public TableTransform createTransform(TableTransformFactoryContext context) {
        ...
        return () -> new QualityRuleTransform(context.getOptions(), catalogTable);
    }
}
