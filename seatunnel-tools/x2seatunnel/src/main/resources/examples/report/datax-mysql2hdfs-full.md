...
| 项目 | 值 |
|------|----| 
| **转换时间** | 2025-07-16T18:14:29.557 |
| **源文件** | `examples/source/datax-mysql2hdfs-full.json` |
| **目标文件** | `examples/target/datax-mysql2hdfs-full.conf` |
| **源类型** | DATAX |
| **目标类型** | SeaTunnel |
| **转换状态** | ✅ 成功 |
...
---
*报告生成时间: 2025-07-16T18:14:29.557*