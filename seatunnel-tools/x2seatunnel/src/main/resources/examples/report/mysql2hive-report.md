...
| 项目 | 值 |
|------|----| 
| **转换时间** | 2025-07-17T18:52:47.989 |
| **源文件** | `examples/source/datax-mysql2hdfs2hive.json` |
| **目标文件** | `examples/target/mysql2hive-result2.conf` |
| **源类型** | DATAX |
| **目标类型** | SeaTunnel |
| **转换状态** | ✅ 成功 |
| **自定义模板** | `templates/datax/custom/mysql-to-hive.conf` |
...
2. 📝 **自定义模板**: 如需调整配置，可以修改自定义模板文件 `templates/datax/custom/mysql-to-hive.conf`。
...
---
*报告生成时间: 2025-07-17T18:52:47.989*