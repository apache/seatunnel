...
| 项目 | 值 |
|------|----| 
| **转换时间** | 2025-07-16T17:21:07.700 |
| **源文件** | `examples/source/datax-mysql2hdfs.json` |
| **目标文件** | `examples/target/mysql2hdfs-result.conf` |
| **源类型** | DATAX |
| **目标类型** | SeaTunnel |
| **转换状态** | ✅ 成功 |
...
|-----------|---------------|----|\n| `reader.name` | `source.template` | `datax/sources/mysql-source.conf` |
...
---
*报告生成时间: 2025-07-16T17:21:07.701*