...
| 项目 | 值 |
|------|----| 
| **转换时间** | 2025-07-10T15:34:50.972 |
| **源文件** | `examples/source/datax-mysql2hdfs.json` |
| **目标文件** | `examples/target/mysql2hdfs-yaml-result.conf` |
| **源类型** | DATAX |
| **目标类型** | SeaTunnel |
| **转换状态** | ✅ 成功 |
...
| `reader.parameter.connection.jdbcUrl` | `source.url` | `jdbc:mysql://localhost:3306/testdb` |
| `reader.parameter.username` | `source.user` | `root` |
| `reader.parameter.password` | `source.password` | `1234567` |
| `writer.name` | `sink.type` | `HdfsFile` |
| `writer.parameter.path` | `sink.path` | `/data/users` |
...
| `source.query` | `SELECT * FROM users` | 根据表名自动构造查询语句 |
...
---
*报告生成时间: 2025-07-10T15:34:50.973*