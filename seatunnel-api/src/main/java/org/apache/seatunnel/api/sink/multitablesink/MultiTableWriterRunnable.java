            ...
            try {
                ...
                synchronized (this) {
                    ...
                    try {
                        ...
                        try {
                            if (tryHandleRowError(writer, row, e)) {
                                processingRow = false;
                                continue;
                            }
                ...
                // When the job finishes, the thread may be interrupted. Preserve the interrupt
                // status and exit the runnable.
                processingRow = false;
                break;
            } catch (Throwable e) {
                try {
