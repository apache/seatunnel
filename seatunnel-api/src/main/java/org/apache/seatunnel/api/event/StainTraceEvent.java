...
/** Carries the serialized stain trace payload emitted when a sampled row reaches the sink side. */
@Getter
@Setter
@ToString
@AllArgsConstructor
...
public class StainTraceEvent implements Event {
    ...
    /** Creates a sink-side stain trace event and timestamps it with the current wall-clock time. */
