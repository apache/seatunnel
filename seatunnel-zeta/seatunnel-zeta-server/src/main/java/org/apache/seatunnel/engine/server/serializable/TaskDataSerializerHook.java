...
package org.apache.seatunnel.zeta.server.serializable;

import org.apache.seatunnel.zeta.common.serializeable.SeaTunnelFactoryIdConstant;
import org.apache.seatunnel.zeta.server.execution.TaskLocation;
import org.apache.seatunnel.zeta.server.task.Progress;
...
import org.apache.seatunnel.zeta.server.task.operation.CleanTaskGroupContextOperation;
import org.apache.seatunnel.zeta.server.task.operation.DeployTaskOperation;
import org.apache.seatunnel.zeta.server.task.operation.GetTaskGroupAddressOperation;
import org.apache.seatunnel.zeta.server.task.operation.GetTaskGroupMetricsOperation;
import org.apache.seatunnel.zeta.server.task.operation.NotifyTaskStatusOperation;
import org.apache.seatunnel.zeta.server.task.operation.checkpoint.BarrierFlowOperation;
import org.apache.seatunnel.zeta.server.task.operation.checkpoint.CloseRequestOperation;
import org.apache.seatunnel.zeta.server.task.operation.sink.SinkPrepareCommitOperation;
import org.apache.seatunnel.zeta.server.task.operation.sink.SinkRegisterOperation;
import org.apache.seatunnel.zeta.server.task.operation.source.AssignSplitOperation;
import org.apache.seatunnel.zeta.server.task.operation.source.LastCheckpointNotifyOperation;
import org.apache.seatunnel.zeta.server.task.operation.source.RequestSplitOperation;
import org.apache.seatunnel.zeta.server.task.operation.source.RestoredSplitOperation;
import org.apache.seatunnel.zeta.server.task.operation.source.SourceNoMoreElementOperation;
import org.apache.seatunnel.zeta.server.task.operation.source.SourceReaderEventOperation;
import org.apache.seatunnel.zeta.server.task.operation.source.SourceRegisterOperation;
