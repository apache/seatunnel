...
import org.apache.seatunnel.zeta.common.utils.ExceptionUtil;
...
import org.apache.seatunnel.zeta.core.job.Job;
...
import org.apache.seatunnel.zeta.server.task.operation.TaskOperation;
import org.apache.seatunnel.zeta.server.task.statemachine.SeaTunnelTaskState;
import org.apache.seatunnel.zeta.server.utils.NodezetaUtil;
...
public class CheckpointManager {
    ...
    public CheckpointManager(long jobId,
        ...
        IMap<Integer, Long> checkpointIdMap =
            nodezeta.getHazelcastInstance().getMap(String.format(IMAP_CHECKPOINT_ID, jobId));
    ...
    protected InvocationFuture<?> sendOperationToMemberNode(TaskOperation operation) {
        return NodezetaUtil.sendOperationToMemberNode(nodezeta, operation,
