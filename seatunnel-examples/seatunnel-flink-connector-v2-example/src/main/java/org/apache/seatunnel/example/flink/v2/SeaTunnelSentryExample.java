...
public class SeaTunnelSentryExample {
    ...
    public static String getTestConfigFile(String configFile) throws FileNotFoundException, URISyntaxException {
        URL resource = SeaTunnelSentryExample.class.getResource(configFile);
        if (resource == null) {
