...
/**
 * Serializes a SeaTunnelRow to an RFC-4180 CSV line for ADX ingestion.
 * Column order matches the SeaTunnelRowType field order.
 * Null fields are emitted as empty (ADX treats empty as null for most types).
 */
