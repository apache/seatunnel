...
public class OscarCreateTableSqlBuilderTest {
    ...
    public void TestCreateTableSqlBuilder() {
        ...
        String createTableSql = new OscarCreateTableSqlBuilder(catalogTable, true).build(tablePath);
        String expect =
        ...
        String createTableSqlSkipIndex =
                new OscarCreateTableSqlBuilder(catalogTable, false).build(tablePath);
    ...
    public void testColumnSinkType() {
        OscarCreateTableSqlBuilder sqlBuilder = mock(OscarCreateTableSqlBuilder.class);
