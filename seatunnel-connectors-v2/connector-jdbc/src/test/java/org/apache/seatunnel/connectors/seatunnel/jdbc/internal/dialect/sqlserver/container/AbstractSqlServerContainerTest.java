...
public abstract class AbstractSqlServerContainerTest {
    ...
    static void startContainer() {
        MSSQL_CONTAINER =
                new MSSQLServerContainer<>(DockerImageName.parse(MSSQL_IMAGE)).acceptLicense();
    ...
    protected org.apache.seatunnel.connectors.seatunnel.jdbc.catalog.sqlserver.SqlServerCatalog
            createSqlServerCatalog() {
        return new org.apache.seatunnel.connectors.seatunnel.jdbc.catalog.sqlserver
                .SqlServerCatalog(
