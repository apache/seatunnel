    ...
    public Column convert(BasicTypeDefine typeDefine) {
        ...
        switch (sybaseType) {
            ...
            case SYBASE_SMALLMONEY:
                builder.sourceType(sybaseType);
                int precision = typeDefine.getPrecision() != null ? typeDefine.getPrecision().intValue() : 38;
            ...
            case SYBASE_TEXT:
                ...
                builder.columnLength(typeDefine.getLength() != null ? typeDefine.getLength() : 8000L);
                break;
            case SYBASE_DATE:
