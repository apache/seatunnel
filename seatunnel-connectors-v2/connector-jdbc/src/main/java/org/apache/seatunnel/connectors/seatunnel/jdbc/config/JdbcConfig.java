...
public class JdbcConfig implements Serializable {
    ...
    public static final Option<String> MAX_COMMIT_ATTEMPTS = Options.key("max_commit_attempts").stringType().defaultValue("3").withDescription("max commit attempts");

    public static final Option<String> TRANSACTION_TIMEOUT_SEC = Options.key("transaction_timeout_sec").stringType().defaultValue("-1").withDescription("transaction timeout (second)");
