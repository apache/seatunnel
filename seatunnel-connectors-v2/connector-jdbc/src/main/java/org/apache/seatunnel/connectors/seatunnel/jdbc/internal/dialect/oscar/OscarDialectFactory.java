...
/** Factory for {@link OscarDialect}. */
@AutoService(JdbcDialectFactory.class)
public class OscarDialectFactory implements JdbcDialectFactory {
    ...
    public boolean acceptsURL(String url) {
        return url.startsWith("jdbc:oscar:");
    }
    ...
    public JdbcDialect create(String compatibleMode, String fieldIde) {
        return new OscarDialect(fieldIde);
    }
}
