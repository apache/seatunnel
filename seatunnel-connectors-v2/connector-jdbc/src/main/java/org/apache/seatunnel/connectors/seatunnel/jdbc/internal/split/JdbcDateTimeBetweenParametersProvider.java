...
public class JdbcDateTimeBetweenParametersProvider extends AbstractParametersProvider {

    /**
     * JdbcDateTimeBetweenParametersProvider constructor.
     *
    ...
    public Serializable[][] getParameterValues() {
        ...
        for (int i = 0; i < batchNum; i++) {
            ...
            parameters[i] = new Timestamp[]{new Timestamp(start), new Timestamp(end)};
            start = end + 1;
        }
        return parameters;
    }
