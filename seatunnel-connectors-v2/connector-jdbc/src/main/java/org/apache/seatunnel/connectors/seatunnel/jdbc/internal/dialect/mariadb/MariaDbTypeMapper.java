...
public class MariaDbTypeMapper implements JdbcDialectTypeMapper {
    ...
    public MariaDbTypeMapper() {
        this(MariaDbTypeConverter.DEFAULT_INSTANCE);
    }

    public MariaDbTypeMapper(MariaDbTypeConverter typeConverter) {
    ...
    public Column mappingColumn(ResultSetMetaData metadata, int colIndex) throws SQLException {
        ...
        if (Arrays.asList("CHAR", "VARCHAR", "ENUM", "UUID", "INET4", "INET6")
                .contains(nativeType.toUpperCase())) {
