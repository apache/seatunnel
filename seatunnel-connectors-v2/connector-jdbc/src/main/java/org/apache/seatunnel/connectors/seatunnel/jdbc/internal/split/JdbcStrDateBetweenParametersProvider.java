...
public class JdbcStrDateBetweenParametersProvider extends AbstractParametersProvider {
     ...
     */
    public JdbcStrDateBetweenParametersProvider(long minVal, long maxVal) {
        super(minVal, maxVal);
    }
     ...
     * @param maxVal    the upper bound of the produced "to" values
     */
    public JdbcStrDateBetweenParametersProvider(long fetchSize, long minVal, long maxVal) {
    ...
    public Serializable[][] getParameterValues() {
        ...
        for (int i = 0; i < batchNum; i++) {
            ...
            parameters[i] = new String[]{new SimpleDateFormat("yyyyMMdd").format(new Date(start)), new SimpleDateFormat("yyyyMMdd").format(new Date(end))};
            start = end + 1;
        }
        return parameters;
    }
