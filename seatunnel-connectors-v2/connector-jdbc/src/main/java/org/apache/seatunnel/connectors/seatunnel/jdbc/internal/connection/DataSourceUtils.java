...
public class DataSourceUtils
    ...
    public static CommonDataSource buildCommonDataSource(@NonNull JdbcConnectionConfig jdbcConnectionConfig)
        throws InvocationTargetException, IllegalAccessException {
        CommonDataSource dataSource = (CommonDataSource) loadDataSource(jdbcConnectionConfig.getXaDataSourceClassName());
