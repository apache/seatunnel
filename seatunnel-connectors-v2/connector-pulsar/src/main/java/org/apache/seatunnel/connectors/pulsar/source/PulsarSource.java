...
import static org.apache.seatunnel.connectors.pulsar.config.SourceProperties.ADMIN_SERVICE_URL;
import static org.apache.seatunnel.connectors.pulsar.config.SourceProperties.AUTH_PARAMS;
import static org.apache.seatunnel.connectors.pulsar.config.SourceProperties.AUTH_PLUGIN_CLASS;
import static org.apache.seatunnel.connectors.pulsar.config.SourceProperties.CLIENT_SERVICE_URL;
import static org.apache.seatunnel.connectors.pulsar.config.SourceProperties.CURSOR_RESET_MODE;
import static org.apache.seatunnel.connectors.pulsar.config.SourceProperties.CURSOR_STARTUP_MODE;
import static org.apache.seatunnel.connectors.pulsar.config.SourceProperties.CURSOR_STARTUP_TIMESTAMP;
import static org.apache.seatunnel.connectors.pulsar.config.SourceProperties.CURSOR_STOP_MODE;
import static org.apache.seatunnel.connectors.pulsar.config.SourceProperties.CURSOR_STOP_TIMESTAMP;
import static org.apache.seatunnel.connectors.pulsar.config.SourceProperties.POLL_BATCH_SIZE;
import static org.apache.seatunnel.connectors.pulsar.config.SourceProperties.POLL_INTERVAL;
import static org.apache.seatunnel.connectors.pulsar.config.SourceProperties.POLL_TIMEOUT;
import static org.apache.seatunnel.connectors.pulsar.config.SourceProperties.SUBSCRIPTION_NAME;
import static org.apache.seatunnel.connectors.pulsar.config.SourceProperties.StartMode;
import static org.apache.seatunnel.connectors.pulsar.config.SourceProperties.StartMode.LATEST;
import static org.apache.seatunnel.connectors.pulsar.config.SourceProperties.StopMode.NEVER;
import static org.apache.seatunnel.connectors.pulsar.config.SourceProperties.TOPIC;
import static org.apache.seatunnel.connectors.pulsar.config.SourceProperties.TOPIC_DISCOVERY_INTERVAL;
import static org.apache.seatunnel.connectors.pulsar.config.SourceProperties.TOPIC_PATTERN;
