...
public class WeaviateSinkCommitter implements SinkCommitter<WeaviateCommitInfo> {
    public WeaviateSinkCommitter(ReadonlyConfig config) {}
     ...
     */
    @Override
    public List<WeaviateCommitInfo> commit(List<WeaviateCommitInfo> commitInfos)
            throws IOException {
     ...
     */
    @Override
    public void abort(List<WeaviateCommitInfo> commitInfos) throws IOException {}
}
