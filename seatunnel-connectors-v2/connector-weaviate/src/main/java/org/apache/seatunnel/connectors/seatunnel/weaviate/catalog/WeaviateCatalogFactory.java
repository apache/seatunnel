...
public class WeaviateCatalogFactory implements CatalogFactory {
    @Override
    public Catalog createCatalog(String catalogName, ReadonlyConfig options) {
        WeaviateParameters weaviateParameters = WeaviateParameters.buildWithConfig(options);
        return new WeaviateCatalog(catalogName, weaviateParameters);
    }
