...
public class WeaviateSinkConfig extends WeaviateCommonConfig {
    ...
    public static final Option<Boolean> ENABLE_VECTOR =
            Options.key("enable_vector")
                    .booleanType()
                    .defaultValue(true)
                    .withDescription("Enable vector");
}
