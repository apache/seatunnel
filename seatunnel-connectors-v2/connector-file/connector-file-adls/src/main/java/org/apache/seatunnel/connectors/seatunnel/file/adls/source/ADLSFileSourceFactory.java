...
package org.apache.seatunnel.connectors.seatunnel.file.adls.source;
...
import org.apache.seatunnel.connectors.seatunnel.file.adls.config.ADLSFileSourceOptions;
...
public class ADLSFileSourceFactory implements TableSourceFactory {
    @Override
    public String factoryIdentifier() {
        return FileSystemType.ADLS.getFileSystemPluginName();
    }
    ...
    public <T, SplitT extends SourceSplit, StateT extends Serializable>
        ...
        return () ->
                (SeaTunnelSource<T, SplitT, StateT>)
                        new ADLSFileSource(context.getOptions(), discoverTableSchemas(context));
    }

    @Override
    public OptionRule optionRule() {
        return OptionRule.builder()
                .required(ADLSFileSourceOptions.FILE_PATH)
                .required(ADLSFileSourceOptions.FILE_FORMAT_TYPE)
                .required(ADLSFileSourceOptions.ACCOUNT_NAME)
                .required(ADLSFileSourceOptions.CONTAINER)
                .required(ADLSFileSourceOptions.ENDPOINT_SUFFIX)
                .required(ADLSFileSourceOptions.AUTH_TYPE)
                .conditional(
                        ADLSFileSourceOptions.AUTH_TYPE,
                        ADLSFileBaseOptions.AuthType.SHARED_KEY,
                        ADLSFileSourceOptions.ACCOUNT_KEY)
                .conditional(
                        ADLSFileSourceOptions.AUTH_TYPE,
                        ADLSFileBaseOptions.AuthType.OAUTH_CLIENT_CREDENTIALS,
