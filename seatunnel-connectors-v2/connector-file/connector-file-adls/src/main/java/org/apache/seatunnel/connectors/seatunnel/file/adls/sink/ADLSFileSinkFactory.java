...
import org.apache.seatunnel.connectors.seatunnel.file.adls.config.ADLSFileSinkOptions;
...
public class ADLSFileSinkFactory implements TableSinkFactory {
    ...
    public OptionRule optionRule() {
        return OptionRule.builder()
                .required(ADLSFileSinkOptions.FILE_PATH)
                .required(ADLSFileSinkOptions.ACCOUNT_NAME)
                .required(ADLSFileSinkOptions.CONTAINER)
                .required(ADLSFileSinkOptions.ENDPOINT_SUFFIX)
                .required(ADLSFileSinkOptions.AUTH_TYPE)
                .optional(FileBaseSinkOptions.SCHEMA_SAVE_MODE)
                .optional(FileBaseSinkOptions.DATA_SAVE_MODE)
                .conditional(
                        ADLSFileSinkOptions.AUTH_TYPE,
                        ADLSFileBaseOptions.AuthType.SHARED_KEY,
                        ADLSFileSinkOptions.ACCOUNT_KEY)
                .conditional(
                        ADLSFileSinkOptions.AUTH_TYPE,
    ...
    public TableSink createSink(TableSinkFactoryContext context) {
        ...
        return () -> new ADLSFileSink(catalogTable, finalConfig);
    }
}
