...
public class GcsFileSink extends BaseMultipleTableFileSink {
    ...
    public GcsFileSink(ReadonlyConfig readonlyConfig, CatalogTable catalogTable) {
        super(GcsHadoopConf.buildWithReadonlyConfig(readonlyConfig), readonlyConfig, catalogTable);
