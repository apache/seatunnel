...
import org.apache.seatunnel.connectors.seatunnel.file.bos.config.BosFileSourceOptions;
...
public class BosFileSourceFactory implements TableSourceFactory {
    ...
    public <T, SplitT extends SourceSplit, StateT extends Serializable>
        ...
        return () -> (SeaTunnelSource<T, SplitT, StateT>) new BosFileSource(context.getOptions());
    }
}
