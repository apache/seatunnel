...
public class OssConf extends HadoopConf {
    ...
    public static HadoopConf buildWithConfig(Config config) {
        ...
        ossOptions.put("fs.oss.accessKeyId", config.getString(OssConfig.ACCESS_KEY));
        ossOptions.put("fs.oss.accessKeySecret", config.getString(OssConfig.ACCESS_SECRET));
        ossOptions.put("fs.oss.endpoint", config.getString(OssConfig.ENDPOINT));
