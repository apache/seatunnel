...
public class LocalExcelTransactionStateFileWriter extends AbstractTransactionStateFileWriter {
    private static final Logger LOGGER = LoggerFactory.getLogger(LocalExcelTransactionStateFileWriter.class);
    private Map<String, ExcelGenerator> beingWrittenWriter;

    public LocalExcelTransactionStateFileWriter(@NonNull SeaTunnelRowType seaTunnelRowTypeInfo,
