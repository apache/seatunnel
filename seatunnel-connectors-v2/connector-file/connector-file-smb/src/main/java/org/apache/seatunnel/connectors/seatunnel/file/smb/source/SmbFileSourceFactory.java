...
public class SmbFileSourceFactory implements TableSourceFactory {
    @Override
    ...
    public <T, SplitT extends SourceSplit, StateT extends Serializable>
        ...
        return () ->
                (SeaTunnelSource<T, SplitT, StateT>)
                        new SmbFileSource(context.getOptions(), discoverTableSchemas(context));
    }

    @Override
    public Class<? extends SeaTunnelSource> getSourceClass() {
        return SmbFileSource.class;
    }
}
