...
package org.apache.seatunnel.connectors.seatunnel.file.smb.sink;
...
import org.apache.seatunnel.connectors.seatunnel.file.smb.config.SmbFileSinkOptions;
...
public class SmbFileSinkFactory extends BaseMultipleTableFileSinkFactory {
    @Override
    public String factoryIdentifier() {
        return FileSystemType.SMB.getFileSystemPluginName();
    }

    @Override
    public OptionRule optionRule() {
        return OptionRule.builder()
                .required(SmbFileSinkOptions.FILE_PATH)
                .required(SmbFileSinkOptions.SMB_HOST)
                .required(SmbFileSinkOptions.SMB_USER)
                .required(SmbFileSinkOptions.SMB_SHARE)
                .optional(SmbFileSinkOptions.SMB_PORT)
                .optional(SmbFileSinkOptions.SMB_PASSWORD)
                .optional(SmbFileSinkOptions.SMB_DOMAIN)
    ...
    public TableSink<SeaTunnelRow, FileSinkState, FileCommitInfo, FileAggregatedCommitInfo>
        ...
        return () -> new SmbFileSink(readonlyConfig, catalogTable);
    }
}
