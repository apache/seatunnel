...
public interface IncomingRecordHandler {
    ...
    /**
     * Handle an incoming batch record from the collector.
     *
     * @param batchId the batch identifier
     * @param payload the raw payload string (may be encrypted/compressed)
     * @return protocol response code to send back to the collector
     */
    String handleBatchRecord(long batchId, String payload);
