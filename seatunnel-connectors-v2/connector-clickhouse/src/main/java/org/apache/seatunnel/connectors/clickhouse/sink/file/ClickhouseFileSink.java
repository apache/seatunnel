...
package org.apache.seatunnel.connectors.clickhouse.sink.file;

import static org.apache.seatunnel.connectors.clickhouse.config.Config.CLICKHOUSE_LOCAL_PATH;
import static org.apache.seatunnel.connectors.clickhouse.config.Config.COPY_METHOD;
import static org.apache.seatunnel.connectors.clickhouse.config.Config.DATABASE;
import static org.apache.seatunnel.connectors.clickhouse.config.Config.FIELDS;
import static org.apache.seatunnel.connectors.clickhouse.config.Config.HOST;
import static org.apache.seatunnel.connectors.clickhouse.config.Config.NODE_ADDRESS;
import static org.apache.seatunnel.connectors.clickhouse.config.Config.NODE_PASS;
import static org.apache.seatunnel.connectors.clickhouse.config.Config.PASSWORD;
import static org.apache.seatunnel.connectors.clickhouse.config.Config.SHARDING_KEY;
import static org.apache.seatunnel.connectors.clickhouse.config.Config.TABLE;
...
import org.apache.seatunnel.connectors.clickhouse.config.ClickhouseFileCopyMethod;
import org.apache.seatunnel.connectors.clickhouse.config.FileReaderOption;
import org.apache.seatunnel.connectors.clickhouse.shard.Shard;
import org.apache.seatunnel.connectors.clickhouse.shard.ShardMetadata;
import org.apache.seatunnel.connectors.clickhouse.sink.client.ClickhouseProxy;
import org.apache.seatunnel.connectors.clickhouse.state.CKAggCommitInfo;
