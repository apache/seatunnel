...
import org.apache.seatunnel.connectors.seatunnel.shopify.source.config.ShopifySourceOptions;
...
public class ShopifySourceFactory extends HttpSourceFactory {
    ...
    public OptionRule optionRule() {
        return getHttpBuilder().required(ShopifySourceOptions.ACCESS_TOKEN).build();
    }
}
