...
public class SchemaChangeManager implements Serializable {
    ...
    private SelectDBSinkConfig selectDBSinkConfig;
    private String charsetEncoding = "UTF-8";

    public SchemaChangeManager(SelectDBSinkConfig selectDBSinkConfig) {
        this.selectDBSinkConfig = selectDBSinkConfig;
    }

    public SchemaChangeManager(SelectDBSinkConfig selectDBSinkConfig, String charsetEncoding) {
        this.selectDBSinkConfig = selectDBSinkConfig;
