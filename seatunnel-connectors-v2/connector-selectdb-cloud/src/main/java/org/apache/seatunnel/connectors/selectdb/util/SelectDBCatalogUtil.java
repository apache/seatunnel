...
@Slf4j
public class SelectDBCatalogUtil {
    ...
    public static final String QUERY_SELECTDB_VERSION_QUERY =
    ...
    public static String getCreateTableStatement(
        ...
        SqlTemplate.canHandledByTemplateWithPlaceholder(
                ...
                SelectDBSinkOptions.SAVE_MODE_CREATE_TEMPLATE.key());
        template =
                template.replaceAll(
        ...
        String rowTypeFields =
                tableSchema.getColumns().stream()
                        ...
                        .map(x -> SelectDBCatalogUtil.columnToSelectDBType(x, typeConverter))
                        .collect(Collectors.joining(",\n"));
        ...
        for (CreateTableParser.ColumnInfo columnInfo : columnInfosInSeq) {
            ...
            if (StringUtils.isEmpty(columnInfo.getInfo())) {
                if (columnMap.containsKey(col)) {
                    ...
                    String newCol = columnToSelectDBType(column, typeConverter);
    ...
    private static String columnToSelectDBType(
