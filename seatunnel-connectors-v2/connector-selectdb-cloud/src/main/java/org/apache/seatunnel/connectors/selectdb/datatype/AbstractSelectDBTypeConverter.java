...
@Slf4j
public abstract class AbstractSelectDBTypeConverter implements TypeConverter<BasicTypeDefine> {
    public static final String SELECTDB_NULL = "NULL";
    public static final String SELECTDB_BOOLEAN = "BOOLEAN";
    public static final String SELECTDB_TINYINT = "TINYINT";
    public static final String SELECTDB_SMALLINT = "SMALLINT";
    public static final String SELECTDB_INT = "INT";
    public static final String SELECTDB_BIGINT = "BIGINT";
    public static final String SELECTDB_LARGEINT = "LARGEINT";
    public static final String SELECTDB_FLOAT = "FLOAT";
    public static final String SELECTDB_DOUBLE = "DOUBLE";
    public static final String SELECTDB_DECIMAL = "DECIMAL";
    public static final String SELECTDB_DECIMALV3 = "DECIMALV3";
    public static final String SELECTDB_DATE = "DATE";
    public static final String SELECTDB_DATETIME = "DATETIME";
    public static final String SELECTDB_CHAR = "CHAR";
    public static final String SELECTDB_VARCHAR = "VARCHAR";
    public static final String SELECTDB_STRING = "STRING";

    public static final String SELECTDB_BOOLEAN_ARRAY = "ARRAY<boolean>";
    public static final String SELECTDB_TINYINT_ARRAY = "ARRAY<tinyint>";
    public static final String SELECTDB_SMALLINT_ARRAY = "ARRAY<smallint>";
    public static final String SELECTDB_INT_ARRAY = "ARRAY<int(11)>";
    public static final String SELECTDB_BIGINT_ARRAY = "ARRAY<bigint>";
    public static final String SELECTDB_FLOAT_ARRAY = "ARRAY<float>";
    public static final String SELECTDB_DOUBLE_ARRAY = "ARRAY<double>";
    public static final String SELECTDB_DECIMALV3_ARRAY = "ARRAY<DECIMALV3>";
    public static final String SELECTDB_DECIMALV3_ARRAY_COLUMN_TYPE_TMP =
            "ARRAY<DECIMALV3(%s, %s)>";
    ...
    public static final String SELECTDB_STRING_ARRAY = "ARRAY<STRING>";

    // Because can not get the column length from array, So the following types of arrays cannot be
    // generated properly.
    public static final String SELECTDB_LARGEINT_ARRAY = "ARRAY<largeint>";
    public static final String SELECTDB_CHAR_ARRAY = "ARRAY<CHAR>";
    public static final String SELECTDB_CHAR_ARRAY_COLUMN_TYPE_TMP = "ARRAY<CHAR(%s)>";
    public static final String SELECTDB_VARCHAR_ARRAY = "ARRAY<VARCHAR>";
    public static final String SELECTDB_VARCHAR_ARRAY_COLUMN_TYPE_TMP = "ARRAY<VARCHAR(%s)>";
    ...
    public static final long MAX_SELECTDB_LARGEINT_TO_VARCHAR_LENGTH = 39L;
    ...
    public void sampleTypeConverter(
        ...
        switch (dorisColumnType) {
            case SELECTDB_NULL:
                ...
                break;
            case SELECTDB_BOOLEAN:
                builder.dataType(BasicType.BOOLEAN_TYPE);
                break;
            case SELECTDB_TINYINT:
                ...
                break;
            case SELECTDB_SMALLINT:
                builder.dataType(BasicType.SHORT_TYPE);
                break;
            case SELECTDB_INT:
                builder.dataType(BasicType.INT_TYPE);
                break;
            case SELECTDB_BIGINT:
                builder.dataType(BasicType.LONG_TYPE);
                break;
            case SELECTDB_FLOAT:
                builder.dataType(BasicType.FLOAT_TYPE);
                break;
            case SELECTDB_DOUBLE:
                builder.dataType(BasicType.DOUBLE_TYPE);
                break;
            case SELECTDB_CHAR:
            case SELECTDB_VARCHAR:
                if (typeDefine.getLength() != null && typeDefine.getLength() > 0) {
                    builder.columnLength(typeDefine.getLength());
                }
                builder.dataType(BasicType.STRING_TYPE);
                break;
            case SELECTDB_LARGEINT:
    ...
    protected void sampleReconvertString(
        ...
        if (column.getColumnLength() < POWER_2_8) {
            if (column.getSourceType() != null
                ...
                builder.columnType(
                        String.format("%s(%s)", SELECTDB_CHAR, column.getColumnLength()));
                builder.dataType(SELECTDB_CHAR);
            }
            return;
        }

        if (column.getColumnLength() <= 65533) {
            builder.columnType(String.format("%s(%s)", SELECTDB_VARCHAR, column.getColumnLength()));
            builder.dataType(SELECTDB_VARCHAR);
            return;
        }
    ...
    protected BasicTypeDefine sampleReconvert(
        ...
        switch (column.getDataType().getSqlType()) {
            case NULL:
                builder.columnType(SELECTDB_NULL);
                builder.dataType(SELECTDB_NULL);
                break;
            case BYTES:
                builder.columnType(SELECTDB_STRING);
                builder.dataType(SELECTDB_STRING);
            ...
            case DECIMAL:
                // DORIS LARGEINT
                if (column.getSourceType() != null
                        && column.getSourceType().equalsIgnoreCase(SELECTDB_LARGEINT)) {
                    builder.dataType(SELECTDB_LARGEINT);
                    builder.columnType(SELECTDB_LARGEINT);
                    break;
                }
                ...
                if (precision <= 0) {
                    ...
                    log.warn(
                            ...
                            MAX_PRECISION);
                    builder.dataType(SELECTDB_VARCHAR);
                    builder.columnType(String.format("%s(%s)", SELECTDB_VARCHAR, 200));
                    break;
                }
    ...
    private void reconvertBuildArrayInternal(
        ...
        switch (elementType.getSqlType()) {
            case BOOLEAN:
                builder.columnType(SELECTDB_BOOLEAN_ARRAY);
                builder.dataType(SELECTDB_BOOLEAN_ARRAY);
                break;
            case TINYINT:
                builder.columnType(SELECTDB_TINYINT_ARRAY);
                builder.dataType(SELECTDB_TINYINT_ARRAY);
                break;
            case SMALLINT:
                builder.columnType(SELECTDB_SMALLINT_ARRAY);
                builder.dataType(SELECTDB_SMALLINT_ARRAY);
                break;
            case INT:
                builder.columnType(SELECTDB_INT_ARRAY);
                builder.dataType(SELECTDB_INT_ARRAY);
                break;
            case BIGINT:
                builder.columnType(SELECTDB_BIGINT_ARRAY);
                builder.dataType(SELECTDB_BIGINT_ARRAY);
                break;
            case FLOAT:
                builder.columnType(SELECTDB_FLOAT_ARRAY);
                builder.dataType(SELECTDB_FLOAT_ARRAY);
                break;
            case DOUBLE:
                builder.columnType(SELECTDB_DOUBLE_ARRAY);
                builder.dataType(SELECTDB_DOUBLE_ARRAY);
                break;
            case DECIMAL:
                int[] precisionAndScale = getPrecisionAndScale(elementType.toString());
                builder.columnType(
                        String.format(
                                SELECTDB_DECIMALV3_ARRAY_COLUMN_TYPE_TMP,
                                precisionAndScale[0],
                                precisionAndScale[1]));
                builder.dataType(SELECTDB_DECIMALV3_ARRAY);
                break;
            case STRING:
            case TIME:
                builder.columnType(SELECTDB_STRING_ARRAY);
                builder.dataType(SELECTDB_STRING_ARRAY);
                break;
            case DATE:
                builder.columnType(SELECTDB_DATEV2_ARRAY);
                builder.dataType(SELECTDB_DATEV2_ARRAY);
                break;
            case TIMESTAMP:
                builder.columnType(SELECTDB_DATETIMEV2_ARRAY);
                builder.dataType(SELECTDB_DATETIMEV2_ARRAY);
                break;
            default:
                throw CommonError.convertToConnectorTypeError(
