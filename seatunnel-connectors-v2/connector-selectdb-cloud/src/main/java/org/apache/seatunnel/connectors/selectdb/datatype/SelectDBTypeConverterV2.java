...
public class SelectDBTypeConverterV2 extends AbstractSelectDBTypeConverter {
    ...
    public static final String SELECTDB_ARRAY = "ARRAY";

    public static final String SELECTDB_ARRAY_BOOLEAN_INTER = "tinyint(1)";
    public static final String SELECTDB_ARRAY_TINYINT_INTER = "tinyint(4)";
    public static final String SELECTDB_ARRAY_SMALLINT_INTER = "smallint(6)";
    public static final String SELECTDB_ARRAY_INT_INTER = "int(11)";
    public static final String SELECTDB_ARRAY_BIGINT_INTER = "bigint(20)";
    public static final String SELECTDB_ARRAY_DECIMAL_PRE = "DECIMAL";
    public static final String SELECTDB_ARRAY_DATE_INTER = "date";
    public static final String SELECTDB_ARRAY_DATEV2_INTER = "DATEV2";
    public static final String SELECTDB_ARRAY_DATETIME_INTER = "DATETIME";
    public static final String SELECTDB_ARRAY_DATETIMEV2_INTER = "DATETIMEV2";

    public static final String SELECTDB_MAP = "MAP";
    public static final String SELECTDB_MAP_COLUMN_TYPE = "MAP<%s, %s>";

    public static final SelectDBTypeConverterV2 INSTANCE = new SelectDBTypeConverterV2();
    ...
    private SeaTunnelDataType turnColumnTypeToSeaTunnelType(String columnType, String columnName) {
        ...
        if (columnType.toUpperCase(Locale.ROOT).startsWith(SELECTDB_ARRAY_DECIMAL_PRE)) {
    ...
    private void convertArray(
        ...
        if (columnInterType.equalsIgnoreCase(SELECTDB_ARRAY_BOOLEAN_INTER)) {
            builder.dataType(ArrayType.BOOLEAN_ARRAY_TYPE);
        } else if (columnInterType.equalsIgnoreCase(SELECTDB_ARRAY_TINYINT_INTER)) {
            builder.dataType(ArrayType.BYTE_ARRAY_TYPE);
        } else if (columnInterType.equalsIgnoreCase(SELECTDB_ARRAY_SMALLINT_INTER)) {
            builder.dataType(ArrayType.SHORT_ARRAY_TYPE);
        } else if (columnInterType.equalsIgnoreCase(SELECTDB_ARRAY_INT_INTER)) {
            builder.dataType(ArrayType.INT_ARRAY_TYPE);
        } else if (columnInterType.equalsIgnoreCase(SELECTDB_ARRAY_BIGINT_INTER)) {
            builder.dataType(ArrayType.LONG_ARRAY_TYPE);
        } else if (columnInterType.equalsIgnoreCase(SELECTDB_FLOAT)) {
            builder.dataType(ArrayType.FLOAT_ARRAY_TYPE);
        } else if (columnInterType.equalsIgnoreCase(SELECTDB_DOUBLE)) {
            builder.dataType(ArrayType.DOUBLE_ARRAY_TYPE);
                ...
                || columnInterType.equalsIgnoreCase(SELECTDB_STRING)) {
            builder.dataType(ArrayType.STRING_ARRAY_TYPE);
        } else if (columnInterType
                .toUpperCase(Locale.ROOT)
                .startsWith(SELECTDB_ARRAY_DECIMAL_PRE)) {
        ...
        } else if (columnInterType.equalsIgnoreCase(SELECTDB_ARRAY_DATE_INTER)
                || columnInterType.equalsIgnoreCase(SELECTDB_ARRAY_DATEV2_INTER)) {
            builder.dataType(ArrayType.LOCAL_DATE_ARRAY_TYPE);
        } else if (columnInterType.equalsIgnoreCase(SELECTDB_ARRAY_DATETIME_INTER)
                || columnInterType.equalsIgnoreCase(SELECTDB_ARRAY_DATETIMEV2_INTER)) {
            builder.dataType(ArrayType.LOCAL_DATE_TIME_ARRAY_TYPE);
        } else if (columnInterType.equalsIgnoreCase(SELECTDB_LARGEINT)) {
        ...
        switch (column.getDataType().getSqlType()) {
            ...
            case TIMESTAMP:
                if (column.getScale() != null
                    ...
                    builder.columnType(
                            String.format("%s(%s)", SELECTDB_DATETIME, column.getScale()));
                    builder.scale(column.getScale());
                } else {
                    builder.columnType(
                            String.format("%s(%s)", SELECTDB_DATETIME, MAX_DATETIME_SCALE));
                    builder.scale(MAX_DATETIME_SCALE);
                }
                builder.dataType(SELECTDB_DATETIME);
                break;
            case MAP:
    ...
    private void reconvertMap(Column column, BasicTypeDefine.BasicTypeDefineBuilder builder) {
        ...
        builder.dataType(String.format(SELECTDB_MAP_COLUMN_TYPE, keyColumnType, valueColumnType));
        builder.columnType(String.format(SELECTDB_MAP_COLUMN_TYPE, keyColumnType, valueColumnType));
    }
