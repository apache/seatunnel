...
public class DeltaLakeSinkOptions extends DeltaLakeCommonOptions {
    ...
    public static final Option<String> ENGINE_INFO =
            Options.key("engine_info")
                    .stringType()
                    .noDefaultValue()
                    .withDescription("engine info");
}
