...
@ToString
public class DeltaLakeScanContext {

    private final TablePath tablePath;
    private final boolean streaming;
    private final DeltaLakeStreamScanStrategy streamScanStrategy;
    ...
    public DeltaLakeScanContext copyWithAppendsBetween(
    ...
    public static DeltaLakeScanContext scanContext(
            DeltaLakeSourceConfig sourceConfig, SourceTableConfig tableConfig, Schema schema) {
        return DeltaLakeScanContext.builder()
    ...
    public static DeltaLakeScanContext streamScanContext(
            DeltaLakeSourceConfig sourceConfig, SourceTableConfig tableConfig, Schema schema) {
