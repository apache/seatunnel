...
public class DeltaLakeCommonOptions {
    ...
    public static final Option<Map<String, String>> CATALOG_PROPS =
            Options.key("iceberg.catalog.config")
                    ...
                    .noDefaultValue()
                    .withDescription(
                            "Specify the properties for initializing the deltalake catalog, which can be referenced in this file:'https://github.com/apache/iceberg/blob/main/core/src/main/java/org/apache/iceberg/CatalogProperties.java'");
    ...
    public static final Option<Boolean> KEY_CASE_SENSITIVE =
            Options.key("case_sensitive")
                    .booleanType()
                    .defaultValue(false)
                    .withDescription(" the deltalake case_sensitive");
