...
import static org.apache.seatunnel.connectors.seatunnel.deltalake.config.DeltaLakeSourceOptions.KEY_STREAM_SCAN_STRATEGY;
...
public class SourceTableConfig implements Serializable {
  ...
  private DeltaLakeStreamScanStrategy streamScanStrategy = KEY_STREAM_SCAN_STRATEGY.defaultValue();
