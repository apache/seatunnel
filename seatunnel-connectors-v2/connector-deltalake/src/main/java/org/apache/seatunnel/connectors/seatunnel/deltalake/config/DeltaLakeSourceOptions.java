...
import org.apache.seatunnel.connectors.seatunnel.deltalake.source.enumerator.scan.DeltaLakeStreamScanStrategy;

import java.util.List;

import static org.apache.seatunnel.connectors.seatunnel.deltalake.source.enumerator.scan.DeltaLakeStreamScanStrategy.FROM_LATEST_SNAPSHOT;

public class DeltaLakeSourceOptions extends DeltaLakeCommonOptions {
    ...
    public static final Option<DeltaLakeStreamScanStrategy> KEY_STREAM_SCAN_STRATEGY =
            Options.key("stream_scan_strategy")
                    .enumType(DeltaLakeStreamScanStrategy.class)
