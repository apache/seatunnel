...
@EqualsAndHashCode
@ToString
public class DeltaLakeEnumeratorPosition implements Serializable {

    private static final long serialVersionUID = 5703291468632501375L;

    public static final DeltaLakeEnumeratorPosition EMPTY = new DeltaLakeEnumeratorPosition(null, null);
