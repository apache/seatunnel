...
/**
 * Emits each received message as a single-column row, used when no {@code schema} is configured.
 */
@AllArgsConstructor
public class WebSocketTextDeserializationSchema implements DeserializationSchema<SeaTunnelRow> {
