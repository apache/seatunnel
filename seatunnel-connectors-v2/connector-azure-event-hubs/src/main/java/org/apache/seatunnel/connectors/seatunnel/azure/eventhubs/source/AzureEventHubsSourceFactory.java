...
public class AzureEventHubsSourceFactory implements TableSourceFactory {
    ...
    public <T, SplitT extends SourceSplit, StateT extends Serializable>
        ...
        AzureEventHubsSourceConfig config = AzureEventHubsSourceConfig.from(context.getOptions());
        ...
        return () ->
                (SeaTunnelSource<T, SplitT, StateT>)
                        new AzureEventHubsSource(
                                context.getOptions(), config, catalogTable, deserializationSchema);
    }

    @Override
    public Class<? extends SeaTunnelSource> getSourceClass() {
        return AzureEventHubsSource.class;
    }

    private DeserializationSchema<SeaTunnelRow> createDeserializationSchema(
            CatalogTable catalogTable, AzureEventHubsSourceConfig config) {
