...
package org.apache.seatunnel.connectors.seatunnel.sensorsdata.sdk.sink;
...
import org.apache.seatunnel.connectors.seatunnel.sensorsdata.sdk.config.SensorsDataSDKSinkConfig;
import org.apache.seatunnel.connectors.seatunnel.sensorsdata.sdk.exception.SensorsDataConnectorErrorCode;
    ...
    public void write(SeaTunnelRow row) throws IOException {
        try {
            switch (recordBuilder.getRecordType()) {
                ...
                default:
                    throw new SensorsDataConnectorException(
                            SensorsDataConnectorErrorCode.SEND_RECORD_FAILED,
            ...
            if (!isSkipErrorRecord) {
                throw new SensorsDataConnectorException(
                        SensorsDataConnectorErrorCode.SEND_RECORD_FAILED, e.getMessage());
            }
        }
    }
