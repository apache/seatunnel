...
//    private final String mapNullKeyLiteral;
    ...
    private RowDataToJsonConverter createTimestampConverter() {
        return (mapper, reuse, value) -> mapper.getNodeFactory()
    ...
    private RowDataToJsonConverter createMapConverter( String typeSummary, SeaTunnelDataType<?> keyType, SeaTunnelDataType<?> valueType) {
