...
public class BigtableConnectorException extends SeaTunnelRuntimeException {
    ...
    public BigtableConnectorException(BigtableConnectorErrorCode errorCode, String errorMessage) {
        super(errorCode, errorMessage);
    }

    public BigtableConnectorException(
            BigtableConnectorErrorCode errorCode, String errorMessage, Throwable cause) {
