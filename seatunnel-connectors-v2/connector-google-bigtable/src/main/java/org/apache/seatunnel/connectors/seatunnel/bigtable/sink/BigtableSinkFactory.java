...
public class BigtableSinkFactory implements TableSinkFactory {
    ...
    public OptionRule optionRule() {
        return OptionRule.builder()
                .required(
                        ...
                        BigtableSinkOptions.COLUMN_FAMILY)
                .optional(
    ...
    public TableSink createSink(TableSinkFactoryContext context) {
        ...
        return () -> new BigtableSink(readonlyConfig, context.getCatalogTable());
    }
}
