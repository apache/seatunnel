...
/** Create and populate a unique instance of a MariaDB database for each run of JUnit test. */
...
public class UniqueDatabase {
    ...
    public UniqueDatabase(MariaDbContainer container, String databaseName) {
        this.container = container;
