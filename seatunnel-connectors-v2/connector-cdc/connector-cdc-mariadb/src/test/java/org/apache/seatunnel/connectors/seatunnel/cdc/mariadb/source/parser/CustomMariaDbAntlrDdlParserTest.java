...
public class CustomMariaDbAntlrDdlParserTest {
    ...
    public void testParseQualifiedTableIdUsesCurrentDatabaseForSameNameTables() {
        ...
        CustomMariaDbAntlrDdlParser parser =
                new CustomMariaDbAntlrDdlParser(sourceConfig.getDbzConnectorConfig());
    ...
    void testParseAlterTableCommentEvent() {
        CustomMariaDbAntlrDdlParser parser = new CustomMariaDbAntlrDdlParser(null);
    ...
    void testParsePropagatesDdlErrors() {
        CustomMariaDbAntlrDdlParser parser = new ParserWithTreeWalkError();
    ...
    private static class ParserWithTreeWalkError extends CustomMariaDbAntlrDdlParser {
