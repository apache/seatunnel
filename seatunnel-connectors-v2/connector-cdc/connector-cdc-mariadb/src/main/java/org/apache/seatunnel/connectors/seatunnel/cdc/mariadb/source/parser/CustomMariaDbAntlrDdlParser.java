...
/** A MariaDB DDL parser that uses custom listeners. */
public class CustomMariaDbAntlrDdlParser extends MySqlAntlrDdlParser {

    private final LinkedList<AlterTableEvent> parsedEvents;
    private final RelationalDatabaseConnectorConfig dbzConnectorConfig;

    public CustomMariaDbAntlrDdlParser(RelationalDatabaseConnectorConfig dbzConnectorConfig) {
    ...
    @Deprecated
    public CustomMariaDbAntlrDdlParser(
    ...
    protected AntlrDdlParserListener createParseTreeWalkerListener() {
        return new CustomMariaDbAntlrDdlParserListener(dbzConnectorConfig, this, parsedEvents);
    }
