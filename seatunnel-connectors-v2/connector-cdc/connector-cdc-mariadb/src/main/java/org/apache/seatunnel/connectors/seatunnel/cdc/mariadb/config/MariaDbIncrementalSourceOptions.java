...
public class MariaDbIncrementalSourceOptions extends JdbcSourceOptions implements CatalogOptions {
    ...
    public static final Option<Boolean> INT_TYPE_NARROWING =
            Options.key("int_type_narrowing")
                    ...
                    .defaultValue(true)
                    .withDescription(
                            "int type narrowing, if true, the tinyint(1) type will be narrowed to the boolean type if without loss of precision. Support for MariaDB.");
