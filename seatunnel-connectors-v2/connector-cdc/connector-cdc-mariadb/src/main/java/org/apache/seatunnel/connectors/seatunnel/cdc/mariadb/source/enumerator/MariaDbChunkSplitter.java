...
package org.apache.seatunnel.connectors.seatunnel.cdc.mariadb.source.enumerator;
...
import org.apache.seatunnel.connectors.seatunnel.cdc.mariadb.utils.MariaDbTypeUtils;
...
@Slf4j
public class MariaDbChunkSplitter extends AbstractJdbcSourceChunkSplitter {

    private final RelationalDatabaseConnectorConfig dbzConnectorConfig;

    public MariaDbChunkSplitter(JdbcSourceConfig sourceConfig, JdbcDataSourceDialect dialect) {
    ...
    public Object[] queryMinMax(JdbcConnection jdbc, TableId tableId, String columnName)
            throws SQLException {
        return MariaDbUtils.queryMinMax(jdbc, tableId, columnName);
    }
    ...
    public Object queryMin(
            ...
            throws SQLException {
        return MariaDbUtils.queryMin(jdbc, tableId, columnName, excludedLowerBound);
    }
    ...
    public Object[] sampleDataFromColumn(
            ...
            throws Exception {
        return MariaDbUtils.skipReadAndSortSampleData(
    ...
    public Object queryNextChunkMax(
            ...
            throws SQLException {
        return MariaDbUtils.queryNextChunkMax(
