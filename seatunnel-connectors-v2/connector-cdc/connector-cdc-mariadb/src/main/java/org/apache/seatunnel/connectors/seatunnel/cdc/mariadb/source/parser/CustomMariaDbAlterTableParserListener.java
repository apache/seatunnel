...
package org.apache.seatunnel.connectors.seatunnel.cdc.mariadb.source.parser;
...
public class CustomMariaDbAlterTableParserListener extends MySqlParserBaseListener
    ...
    private CustomMariaDbColumnDefinitionParserListener columnDefinitionListener;

    private int parsingColumnIndex = STARTING_INDEX;

    private final RelationalDatabaseConnectorConfig dbzConnectorConfig;

    public CustomMariaDbAlterTableParserListener(
    ...
    public void enterAlterByAddColumn(MySqlParser.AlterByAddColumnContext ctx) {
        ...
        columnDefinitionListener =
                new CustomMariaDbColumnDefinitionParserListener(columnEditor, parser, listeners);
    ...
    public org.apache.seatunnel.api.table.catalog.Column toSeatunnelColumn(Column column) {
        return MariaDbTypeUtils.convertToSeaTunnelColumn(column, dbzConnectorConfig);
    }
}
