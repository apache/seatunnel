...
/**
 * Describes the connection information of the MariaDB database and the configuration information
 * for performing snapshotting and streaming reading, such as splitSize.
 */
public class MariaDbSourceConfig extends JdbcSourceConfig {

    private static final long serialVersionUID = 1L;

    public MariaDbSourceConfig(
