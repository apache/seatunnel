...
/** Parser listener that is parsing column definition part of MariaDB statements. */
@Slf4j
public class CustomMariaDbColumnDefinitionParserListener extends MySqlParserBaseListener {
    ...
    public CustomMariaDbColumnDefinitionParserListener(
    ...
    public void enterColumnDefinition(MySqlParser.ColumnDefinitionContext ctx) {
        ...
        defaultValueListener =
                new CustomMariaDbDefaultValueParserListener(columnEditor, optionalColumn);
    ...
    private void resolveColumnDataType(MySqlParser.DataTypeContext dataTypeContext) {
        ...
        if (dataTypeContext instanceof MySqlParser.StringDataTypeContext) {
            ...
            if (dataType.name().equalsIgnoreCase("SET")) {
                ...
                columnEditor.length(Math.max(0, optionsSize * 2 - 1));
            } else {
