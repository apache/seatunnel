...
public class PostgresSnapshotSplitReadTask
    ...
    protected SnapshotResult<PostgresOffsetContext> doExecute(
        ...
        dispatcher.dispatchWatermarkEvent(
                ...
                highWatermark,
                WatermarkKind.HIGH);
        return SnapshotResult.<PostgresOffsetContext>completed(ctx.offset);
    }
    ...
    protected AbstractSnapshotChangeEventSource.SnapshotContext<
            ...
            prepare(PostgresPartition partition) throws Exception {
    ...
    protected ChangeRecordEmitter<PostgresPartition> getChangeRecordEmitter(
        ...
        return new SnapshotChangeRecordEmitter<PostgresPartition>(
