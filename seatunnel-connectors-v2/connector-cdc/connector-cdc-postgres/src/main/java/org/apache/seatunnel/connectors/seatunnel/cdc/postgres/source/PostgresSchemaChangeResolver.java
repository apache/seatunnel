...
import org.apache.seatunnel.connectors.seatunnel.cdc.postgres.source.parser.PostgresAlterTableParser;
...
public class PostgresSchemaChangeResolver extends AbstractSchemaChangeResolver {

    public PostgresSchemaChangeResolver(
    ...
    protected DdlParser createDdlParser(TablePath tablePath) {
        return new PostgresAlterTableParser(tablePath);
    }

    @Override
    protected List<AlterTableColumnEvent> getAndClearParsedEvents() {
        return ((PostgresAlterTableParser) ddlParser).getAndClearParsedEvents();
    }
