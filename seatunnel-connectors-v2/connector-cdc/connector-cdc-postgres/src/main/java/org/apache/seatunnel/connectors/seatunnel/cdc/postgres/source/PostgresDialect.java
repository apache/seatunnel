...
import static org.apache.seatunnel.connectors.seatunnel.cdc.postgres.utils.PostgresConnectionUtils.createPostgresConnection;
...
public class PostgresDialect implements JdbcDataSourceDialect {
    ...
    public JdbcConnection openJdbcConnection(JdbcSourceConfig sourceConfig) {
        ...
        Configuration jdbcConfig = dbzConnectorConfig.getJdbcConfig();
        return createPostgresConnection(jdbcConfig);
    }
