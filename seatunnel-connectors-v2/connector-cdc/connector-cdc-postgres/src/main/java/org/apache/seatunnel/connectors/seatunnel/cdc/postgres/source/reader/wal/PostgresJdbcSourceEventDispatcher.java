 ...
 * </pre>
 */
public class PostgresJdbcSourceEventDispatcher extends EventDispatcher<TableId> {

    private final ChangeEventQueue<DataChangeEvent> queue;

    private final String topic;

    public PostgresJdbcSourceEventDispatcher(
    ...
    public boolean dispatchDataChangeEvent(
            TableId dataCollectionId, ChangeRecordEmitter changeRecordEmitter)
            throws InterruptedException {
        super.dispatchDataChangeEvent(dataCollectionId, changeRecordEmitter);
