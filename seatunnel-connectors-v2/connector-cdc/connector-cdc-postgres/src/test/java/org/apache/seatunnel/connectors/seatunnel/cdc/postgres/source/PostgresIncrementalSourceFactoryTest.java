...
class PostgresIncrementalSourceFactoryTest {

    private final OptionRule rule = new PostgresIncrementalSourceFactory().optionRule();

    private void validate(Map<String, Object> config) {
        ConfigValidator.of(ReadonlyConfig.fromMap(config)).validate(rule);
    }

    private Map<String, Object> validPostgresConfig() {
    ...
    public void testTableNamesFormatExtension() {
        Map<String, Object> cfgInvalid = validPostgresConfig();
        ...
        Map<String, Object> cfgValidThreeSegment = validPostgresConfig();
    ...
    public void testDatabaseNamesRequired() {
        Map<String, Object> cfgMissing = validPostgresConfig();
