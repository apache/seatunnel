...
public class PostgresConnection extends JdbcConnection {
    ...
    protected static final ConnectionFactory FACTORY =
            JdbcConnection.patternBasedFactory(
                    ...
                    JdbcConfiguration.HOSTNAME.withDefault(
                            PostgresConnectorConfig.HOSTNAME.defaultValueAsString()),
                    JdbcConfiguration.DATABASE.withDefault(
                            PostgresConnectorConfig.DATABASE_NAME.defaultValueAsString()));
