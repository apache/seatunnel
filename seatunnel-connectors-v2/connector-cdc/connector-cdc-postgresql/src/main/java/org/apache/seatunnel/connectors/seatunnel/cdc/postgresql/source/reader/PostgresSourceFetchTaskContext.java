...
package org.apache.seatunnel.connectors.seatunnel.cdc.postgresql.source.reader;
...
import org.apache.seatunnel.connectors.seatunnel.cdc.postgresql.source.offset.LsnOffset;
import org.apache.seatunnel.connectors.seatunnel.cdc.postgresql.utils.PostgresUtils;
...
public class PostgresSourceFetchTaskContext extends JdbcSourceFetchTaskContext {
    ...
    public PostgresSourceFetchTaskContext(
        ...
        this.dataConnection = createPostgresConnection(sourceConfig.getDbzConfiguration());
