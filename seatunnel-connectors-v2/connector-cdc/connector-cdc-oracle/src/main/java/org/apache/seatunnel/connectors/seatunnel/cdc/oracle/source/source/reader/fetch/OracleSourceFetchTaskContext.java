...
package org.apache.seatunnel.connectors.seatunnel.cdc.oracle.source.source.reader.fetch;
...
public class OracleSourceFetchTaskContext extends JdbcSourceFetchTaskContext {
    ...
    public SeaTunnelRowType getSplitType(Table table) {
        ...
        return OracleUtils.getSplitType(table, oracleSourceConfig);
    }
    ...
    public OracleConnection getDataConnection() {
        return connection;
    }
