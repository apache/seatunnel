...
/**
 * Declares the Debezium version that the Oracle CDC connector is built and packaged against.
 *
 * <p>The version is owned by this module: {@code connector-cdc-base} declares Debezium as {@code
 * provided}, so the Debezium runtime a Oracle CDC job loads comes from this connector's own shaded
...
public class OracleDebeziumAdapter implements DebeziumAdapter {
     ...
     * property in this module's {@code pom.xml}; {@code OracleDebeziumAdapterTest} compares it
     ...
     */
    private static final String CONNECTOR_CLASS = "io.debezium.connector.oracle.OracleConnector";
