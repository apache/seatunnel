...
/**
 * Declares the Debezium version that the Vitess CDC connector is built and packaged against.
 *
 * <p>The version is owned by this module: {@code connector-cdc-base} declares Debezium as {@code
 * provided}, so the Debezium runtime a Vitess CDC job loads comes from this connector's own shaded
 * jar at this module's {@code debezium.version} property.
 */
public class VitessDebeziumAdapter implements DebeziumAdapter {

    /**
     * Debezium version this connector ships. Must stay equal to the {@code debezium.version}
     * property in this module's {@code pom.xml}; {@code VitessDebeziumAdapterTest} compares it
     ...
     */
    private static final String CONNECTOR_CLASS = "io.debezium.connector.vitess.VitessConnector";
