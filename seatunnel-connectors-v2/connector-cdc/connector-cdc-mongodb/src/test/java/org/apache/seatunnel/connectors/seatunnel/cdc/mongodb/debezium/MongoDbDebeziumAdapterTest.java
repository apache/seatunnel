 ...
 * MongoDbDebeziumAdapter} reports, and the Debezium actually resolved onto the connector's
...
class MongoDbDebeziumAdapterTest {
    ...
    void declaredVersionMatchesPackagedDebezium() throws Exception {
        Assertions.assertEquals(
                resolvedDebeziumCoreVersion(), new MongoDbDebeziumAdapter().getDebeziumVersion());
    }
