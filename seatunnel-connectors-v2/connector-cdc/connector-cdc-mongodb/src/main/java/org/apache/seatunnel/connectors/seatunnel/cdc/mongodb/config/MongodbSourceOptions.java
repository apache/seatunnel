...
public class MongodbSourceOptions extends SourceOptions {
    ...
    public static final Option<Boolean> FULL_INCREMENTAL_INTEGRATION =
            Options.key("full-incremental.integration")
                    .booleanType()
                    .defaultValue(Boolean.TRUE)
                    .withDescription(
                            "If you want to retrieve the complete dataset upon startup, you can set it to true. If you are only interested in changes after startup, you can keep it at the default value of false.");

    public static final Option<Integer> FULL_INCREMENTAL_QUEUE_SIZE =
            Options.key("full-incremental.queue.size")
                    .intType()
                    .defaultValue(10240)
                    .withDescription(
                            "The max size of the queue to use when full-incremental integration mode. Defaults to 10240.");
