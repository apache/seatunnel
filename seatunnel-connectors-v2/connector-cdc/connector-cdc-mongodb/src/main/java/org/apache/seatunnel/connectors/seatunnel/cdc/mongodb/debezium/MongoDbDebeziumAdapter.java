...
/**
 * Declares the Debezium version that the MongoDB CDC connector is built and packaged against.
 *
 * <p>The version is owned by this module: {@code connector-cdc-base} declares Debezium as {@code
 * provided}, so the Debezium runtime a MongoDB CDC job loads comes from this connector's own shaded
 * jar at this module's {@code debezium.version} property.
 */
public class MongoDbDebeziumAdapter implements DebeziumAdapter {

    /**
     * Debezium version this connector ships. Must stay equal to the {@code debezium.version}
     * property in this module's {@code pom.xml}; {@code MongoDbDebeziumAdapterTest} compares it
     ...
     */
    private static final String CONNECTOR_CLASS = "io.debezium.connector.mongodb.MongoDbConnector";
