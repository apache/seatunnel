...
public class MongodbSourceConfig implements SourceConfig {
    ...
    private final boolean fullIncrementalIntegration;

    private final int fullIncrementalQueueSize;
    ...
    MongodbSourceConfig(
            ...
            int splitSizeMB,
            boolean fullIncrementalIntegration,
            int fullIncrementalQueueSize) {
