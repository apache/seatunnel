...
import static org.apache.seatunnel.connectors.seatunnel.cdc.mongodb.config.MongodbSourceOptions.FULL_INCREMENTAL_INTEGRATION;
import static org.apache.seatunnel.connectors.seatunnel.cdc.mongodb.config.MongodbSourceOptions.FULL_INCREMENTAL_QUEUE_SIZE;
...
public class MongodbSourceConfigProvider {
    ...
    public static class Builder implements SourceConfig.Factory<MongodbSourceConfig> {
        ...
        private Integer splitMetaGroupSize = 2;
        private Integer splitSizeMB = INCREMENTAL_SNAPSHOT_CHUNK_SIZE_MB.defaultValue();

        private boolean fullIncrementalIntegration = FULL_INCREMENTAL_INTEGRATION.defaultValue();

        private int fullIncrementalQueueSize = FULL_INCREMENTAL_QUEUE_SIZE.defaultValue();
        ...
        public Builder databaseList(String... databases) {
            this.databaseList = Arrays.asList(databases);
            return this;
        }

        public Builder collectionList(String... collections) {
        ...
        public Builder fullIncrementalIntegration(boolean fullIncrementalIntegration) {
            this.fullIncrementalIntegration = fullIncrementalIntegration;
            return this;
        }

        public Builder fullIncrementalQueueSize(int fullIncrementalQueueSize) {
            this.fullIncrementalQueueSize = fullIncrementalQueueSize;
            return this;
        }
        ...
        public MongodbSourceConfig create(int subtask) {
            ...
            return new MongodbSourceConfig(
                    ...
                    splitMetaGroupSize,
                    splitSizeMB,
                    fullIncrementalIntegration,
                    fullIncrementalQueueSize);
        }
    }
}
