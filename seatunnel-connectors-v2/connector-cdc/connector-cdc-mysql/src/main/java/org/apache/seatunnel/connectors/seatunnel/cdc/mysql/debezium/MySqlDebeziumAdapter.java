...
/**
 * Declares the Debezium version that the MySQL CDC connector is built and packaged against.
 *
 * <p>The version is owned by this module: {@code connector-cdc-base} declares Debezium as {@code
 * provided}, so the Debezium runtime a MySQL CDC job loads comes from this connector's own shaded
...
public class MySqlDebeziumAdapter implements DebeziumAdapter {
     ...
     * property in this module's {@code pom.xml}; {@code MySqlDebeziumAdapterTest} compares it
