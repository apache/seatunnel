...
public class Db2IncrementalSourceFactory implements TableSourceFactory, SupportMultipleTable {
    ...
    public OptionRule optionRule() {
        return JdbcSourceOptions.getBaseRule()
                ...
                .optional(Db2SourceOptions.STARTUP_MODE, Db2SourceOptions.STOP_MODE)
                .conditional(
                        Db2SourceOptions.STARTUP_MODE,
                        StartupMode.SPECIFIC,
                        SourceOptions.STARTUP_SPECIFIC_OFFSET_POS)
                .conditional(
                        Db2SourceOptions.STOP_MODE,
                        StopMode.SPECIFIC,
    ...
    public <T, SplitT extends SourceSplit, StateT extends Serializable>
        ...
        return () -> {
            ...
            return new Db2IncrementalSource(context.getOptions(), dataType);
        };
    }
