...
package org.apache.seatunnel.connectors.seatunnel.cdc.db2.source.enumerator;
...
import org.apache.seatunnel.connectors.seatunnel.cdc.db2.utils.Db2TypeUtils;
import org.apache.seatunnel.connectors.seatunnel.cdc.db2.utils.Db2Utils;
...
@Slf4j
public class Db2ChunkSplitter extends AbstractJdbcSourceChunkSplitter {
    ...
    public Object[] sampleDataFromColumn(
            ...
            throws Exception {
        return Db2Utils.skipReadAndSortSampleData(jdbc, tableId, columnName, inverseSamplingRate);
    }
    ...
    public String buildSplitScanQuery(
        ...
        return Db2Utils.buildSplitScanQuery(table.id(), splitKeyType, isFirstSplit, isLastSplit);
    }

    @Override
    public SeaTunnelDataType<?> fromDbzColumn(Column splitColumn) {
        return Db2TypeUtils.convertFromColumn(splitColumn);
    }
}
