...
package org.apache.seatunnel.connectors.seatunnel.cdc.db2.source.reader.fetch;
...
public class Db2SourceFetchTaskContext extends JdbcSourceFetchTaskContext {
    ...
    private Db2Connection metadataConnection;
            ...
            synchronized (this) {
                if (this.metadataConnection == null) {
                    this.metadataConnection =
                            Db2ConnectionUtils.createDb2Connection(
