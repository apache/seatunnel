...
/**
 * Declares the Debezium version that the SQL Server CDC connector is built and packaged against.
 *
 * <p>The version is owned by this module: {@code connector-cdc-base} declares Debezium as {@code
 * provided}, so the Debezium runtime a SQL Server CDC job loads comes from this connector's own
...
public class SqlServerDebeziumAdapter implements DebeziumAdapter {
     ...
     * property in this module's {@code pom.xml}; {@code SqlServerDebeziumAdapterTest} compares it
