 ...
 * SqlServerDebeziumAdapter} reports, and the Debezium actually resolved onto the connector's
...
class SqlServerDebeziumAdapterTest {
    ...
    void declaredVersionMatchesPackagedDebezium() throws Exception {
        Assertions.assertEquals(
                resolvedDebeziumCoreVersion(), new SqlServerDebeziumAdapter().getDebeziumVersion());
    }
