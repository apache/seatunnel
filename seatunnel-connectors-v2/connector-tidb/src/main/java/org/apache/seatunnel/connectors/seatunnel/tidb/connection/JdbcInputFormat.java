...
import org.apache.seatunnel.connectors.seatunnel.tidb.converter.JdbcRowConverter;
import org.apache.seatunnel.connectors.seatunnel.tidb.source.TiDBSourceSplit;
...
public class JdbcInputFormat implements Serializable {
     ...
     */
    public void open(TiDBSourceSplit inputSplit) throws IOException {
        try {
