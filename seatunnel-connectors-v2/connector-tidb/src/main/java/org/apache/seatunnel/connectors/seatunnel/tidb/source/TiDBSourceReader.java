...
public class TiDBSourceReader implements SourceReader<SeaTunnelRow, TiDBSourceSplit> {
    ...
    Context context;
    Deque<TiDBSourceSplit> splits = new LinkedList<>();
    JdbcInputFormat inputFormat;
    boolean noMoreSplit;

    public TiDBSourceReader(JdbcInputFormat inputFormat, SourceReader.Context context) {
    ...
    public void pollNext(Collector<SeaTunnelRow> output) throws Exception {
        TiDBSourceSplit split = splits.poll();
        if (null != split) {
