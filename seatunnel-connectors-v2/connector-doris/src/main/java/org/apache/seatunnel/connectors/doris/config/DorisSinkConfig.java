...
public class DorisSinkConfig implements Serializable {
    ...
    /**
     * Session zone used to convert {@code TIMESTAMP_TZ} values into wall-clock strings for Doris
     * DATETIME columns. When {@code null}, the JVM default timezone is used (legacy behavior).
     */
    ...
    private static ZoneId parseDatetimeTimezone(ReadonlyConfig config) {
        ...
        try {
            ...
            throw new DorisConnectorException(
                    ...
                    "PluginName: Doris, Message: Option 'sink.datetime-timezone' is not a "
                            + "valid ZoneId ID: "
                            + zoneId,
                    e);
        }
