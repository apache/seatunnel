...
import static org.apache.seatunnel.connector.doris.sink.LoadStatus.PUBLISH_TIMEOUT;
import static org.apache.seatunnel.connector.doris.sink.LoadStatus.SUCCESS;
import static org.apache.seatunnel.connector.doris.sink.writer.LoadConstants.FIELD_DELIMITER_KEY;
import static org.apache.seatunnel.connector.doris.sink.writer.LoadConstants.FORMAT_KEY;
...
import org.apache.seatunnel.connector.doris.rest.RestService;
...
import org.apache.seatunnel.connector.doris.serialize.DorisCsvSerializer;
import org.apache.seatunnel.connector.doris.serialize.DorisJsonSerializer;
import org.apache.seatunnel.connector.doris.serialize.DorisSerializer;
import org.apache.seatunnel.connector.doris.sink.committer.DorisCommitInfo;
import org.apache.seatunnel.connector.doris.util.HttpUtil;
...
public class DorisSinkWriter implements SinkWriter<SeaTunnelRow, DorisCommitInfo, DorisSinkState> {
    ...
    public static DorisSerializer createSerializer(DorisConfig dorisConfig, SeaTunnelRowType seaTunnelRowType) {
        if (LoadConstants.CSV.equals(dorisConfig.getStreamLoadProps().getProperty(FORMAT_KEY))) {
            return new DorisCsvSerializer(dorisConfig.getStreamLoadProps().getProperty(FIELD_DELIMITER_KEY), seaTunnelRowType);
        }
        if (LoadConstants.JSON.equals(dorisConfig.getStreamLoadProps().getProperty(FORMAT_KEY))) {
