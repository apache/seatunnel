...
package org.apache.seatunnel.connector.doris.sink;

import static org.apache.seatunnel.connector.doris.config.DorisConfig.FENODES;
import static org.apache.seatunnel.connector.doris.config.DorisConfig.TABLE_IDENTIFIER;
import static org.apache.seatunnel.connector.doris.config.DorisConfig.USERNAME;
...
import org.apache.seatunnel.connector.doris.sink.committer.DorisCommitInfoSerializer;
import org.apache.seatunnel.connector.doris.sink.committer.DorisCommitter;
import org.apache.seatunnel.connector.doris.sink.writer.DorisSinkState;
import org.apache.seatunnel.connector.doris.sink.writer.DorisSinkStateSerializer;
import org.apache.seatunnel.connector.doris.sink.writer.DorisSinkWriter;
...
public class DorisSink implements SeaTunnelSink<SeaTunnelRow, DorisSinkState, DorisCommitInfo, DorisCommitInfo> {
    ...
    public void prepare(Config pluginConfig) throws PrepareFailException {
        ...
        CheckResult result = CheckConfigUtil.checkAllExists(pluginConfig, FENODES.key(), USERNAME.key(), TABLE_IDENTIFIER.key());
        if (!result.isSuccess()) {
