...
package org.apache.seatunnel.connector.doris.serialize;
...
public class DorisBaseSerializer {
    ...
    protected String convert(SeaTunnelDataType dataType, Object val) {
        ...
        switch (dataType.getSqlType()) {
            ...
            default:
                throw new DorisConnectorException(CommonErrorCode.UNSUPPORTED_DATA_TYPE, dataType + " is not supported ");
        }
    }
}
