...
public class RawPayloadSerializerFactory implements EdgePayloadSerializerFactory {
    ...
    public OptionRule optionRule() {
        return OptionRule.builder().optional(EdgeTransportOptions.PACKET_MODE).build();
    }

    @Override
    public PayloadSerializer create(ReadonlyConfig config) {
        return new RawPayloadSerializer();
    }
}
