...
/** Edge collector line protocol aligned with {@code EdgeSocketSourceReader} on the engine side. */
public final class EdgeSocketProtocol {

    public static final String RESP_ACK = "ACK";
    public static final String RESP_ACK_PREFIX = "ACK:";
    public static final String RESP_PENDING = "PENDING";
    ...
    public static final String COMMIT_PREFIX = "__COMMIT__:";

    private EdgeSocketProtocol() {}
}
