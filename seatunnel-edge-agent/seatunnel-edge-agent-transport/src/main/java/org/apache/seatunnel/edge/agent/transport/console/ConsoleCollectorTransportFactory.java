...
public class ConsoleCollectorTransportFactory implements EdgeCollectorTransportFactory {
    ...
    public OptionRule optionRule() {
        return OptionRule.builder().required(EdgeOutputOptions.TYPE).build();
    }

    @Override
    public EdgeCollectorTransport create(ReadonlyConfig outputConfig) {
        return new ConsoleCollectorTransport();
    }
}
