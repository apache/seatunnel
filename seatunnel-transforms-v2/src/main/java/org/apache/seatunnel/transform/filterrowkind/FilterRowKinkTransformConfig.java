...
public class FilterRowKinkTransformConfig {
    ...
    public static FilterRowKinkTransformConfig of(ReadonlyConfig config) {
        ...
        if ((filterRowKinkTransformConfig.getIncludeKinds().isEmpty()
                        && filterRowKinkTransformConfig.getExcludeKinds().isEmpty())
                || (!filterRowKinkTransformConfig.getIncludeKinds().isEmpty()
                        && !filterRowKinkTransformConfig.getExcludeKinds().isEmpty())) {
