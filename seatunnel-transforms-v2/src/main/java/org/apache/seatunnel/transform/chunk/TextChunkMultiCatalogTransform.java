...
public class TextChunkMultiCatalogTransform extends AbstractMultiCatalogFlatMapTransform {

    public TextChunkMultiCatalogTransform(
    ...
    protected SeaTunnelFlatMapTransform<SeaTunnelRow> buildTransform(
        ...
        return new TextChunkTransform(TextChunkTransformConfig.of(config), inputCatalogTable);
    }
