...
public class CopyFieldTransformFactory implements TableTransformFactory {
    ...
    public OptionRule optionRule() {
        return OptionRule.builder().required(CopyFieldTransformConfig.SRC_FIELD, CopyFieldTransformConfig.DEST_FIELD)
            .build();
    }

    @Override
    public TableTransform createTransform(TableFactoryContext context) {
        CopyFieldTransformConfig copyFieldTransformConfig = CopyFieldTransformConfig.of(context.getOptions());
