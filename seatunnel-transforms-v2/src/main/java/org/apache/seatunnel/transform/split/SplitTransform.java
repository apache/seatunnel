...
public class SplitTransform extends MultipleFieldOutputTransform {
    ...
    protected Column[] getOutputColumns() {
        List<PhysicalColumn> collect = Arrays.stream(splitTransformConfig.getOutputFields()).map(fieldName -> {
            return PhysicalColumn.of(fieldName, BasicType.STRING_TYPE, 200, true, "", "");
