                    ...
                    .map(
                            tableTransforms -> {
                                ReplaceTransformConfig replaceTransformConfig =
                                        new ReplaceTransformConfig();
                                replaceTransformConfig.setReplaceField(
                                        tableTransforms.getReplaceField());
                                replaceTransformConfig.setPattern(tableTransforms.getPattern());
                                replaceTransformConfig.setReplacement(
                                        tableTransforms.getReplacement());
                                replaceTransformConfig.setIsRegex(tableTransforms.getIsRegex());
                                replaceTransformConfig.setReplaceFirst(
