...
/**
 * DES decryption UDF. Password must be at least 8 characters. Input data should be Base64-encoded
 * ciphertext.
 *
 * <p>Usage: {@code DES_DECRYPT(password, data)}
 */
@AutoService(CalciteUdf.class)
public class DesDecryptFunction implements CalciteUdf {
