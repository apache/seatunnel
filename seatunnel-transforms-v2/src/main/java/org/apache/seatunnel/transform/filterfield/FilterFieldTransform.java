...
public class FilterFieldTransform extends AbstractCatalogSupportTransform {
    ...
    protected void setConfig(Config pluginConfig) {
        ...
        config = FilterFieldTransformConfig.of(ReadonlyConfig.fromConfig(pluginConfig));
    }
