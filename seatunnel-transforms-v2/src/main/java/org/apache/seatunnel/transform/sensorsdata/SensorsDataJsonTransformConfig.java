...
@Getter
public class SensorsDataJsonTransformConfig extends SensorsDataConfigBase {

    private final String jsonColumnName;

    public SensorsDataJsonTransformConfig(ReadonlyConfig config) {
        super(config);
        this.jsonColumnName = config.get(SensorsDataOptions.JSON_COLUMN_NAME);
    }
}
